...
export const psalmsData = {
  ...
  221: {
    0.0: {
        ...
        "text_lat": "Pater noster, qui es in cælis:^lsanctificétur nomen tuum;^ladvéniat regnum tuum;^lfiat volúntas tua, sicut°in°cælo°et°in°terra.^lPanem nostrum cotidiánum da°nobis°hódie;^let dimítte nobis débita nostra,^lsicut et nos dimíttimus debitóribus°nostris;^let ne nos indúcas in tentatiónem;^lsed líbera nos a malo."
      },
    1.0: {
  ...
  2523: {
    ...
    1.0: {
        "quote": "Komplet",
        "text": "Ave, Regína cælórum,^lave, Dómina angelórum,^lsalve, radix, salve, porta,^lex qua mundo lux est orta.^lGaude, Virgo gloriósa,^lsuper omnes speciósa;^lvale, o°valde decóra,^let pro nobis Christum exóra."
      }
  },
  2524: {
    0.0: {
  ...
  2526: {
    0.0: {
        ...
        "text_lat": "Sub tuum præsídium confúgimus,^lsancta Dei Génetrix;^lnostras deprecatiónes^lne despícias in necessitátibus;^lVirgo gloriósa et benedícta."
      },
    1.0: {
        "quote": "Komplet",
