...
export const userMessages = {
    "16.07.2026": "Die Einrichtung der Psalmen zum Singen (cant) ist jetzt auch mit den anderen Sprachvarianten (lateinisch, neue Einheitsübersetzung, Benediktinisches Antiphonale) kombinierbar. Damit ist vorbereitet, dass die Psalmen nach und nach in allen Sprachvarianten zum Singen eingerichtet werden.",
    "14.05.2026": "#Für die Erzbistümer Paderborn und Köln sowie die Bistümer Limburg, Trier und Speyer sind die ersten Eigenfeiern eingetragen. Wählen Sie dafür in den Einstellungen das jeweiige Bistum aus. Weitere Eigenfeiern werden so ergänzt, dass sie bei Bedarf verfügbar sein werden.",
    "28.02.2026": "#Ab sofort können Psalmen zum Singen eingerichtet angezeigt werden. Wählen Sie dazu ^fin den Spracheinstellungen die Option [cant]^0f. Wenn Sie den Button [cant] lange gedrückt halten, können Sie dies als ihre Grundeinstellung bei jedem Start der App speichern.^lDer Bestand an Psalmen wird nach und nach erweitert, zunächst für Laudes, Vesper und Komplet. Noch nicht eingerichtete Psalmen werden in der Übergangszeit einfach mit dem Text des Stundenbuchs angezeigt.^lEs wird zu jedem Psalm ein Psalmton vorgeschlagen, und zwar entsprechend dem „Antiphonale zum Stundengebet“. Durch einen ^fKlick auf die Notenzeile^0f des Psalmodiemodells kann aber jeder andere Psalmton ausgewählt werden.^lKorrekturhinweise sind – wie in allen anderen Fällen – auch bei der Einrichtung zum Singen herzlich willkommen! Senden Sie diese bitte an ^kdirektorium@bistum^-fulda.de^0k. Vielen°Dank!",
