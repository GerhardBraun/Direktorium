    ...
    "2": {
      "eig": {
        ...
        "Lesehore": {
          ...
          "patr_werk": "Aus einer Rede auf Basilius den Großen.",
          "patr_text": "^hEine Seele lebt in zwei Körpern^pIn Athen fanden wir beide, Basilius und ich, uns vereint. Athen hatte uns wieder! Wie wenn sich ein Gewässer an der einen heimatlichen Quelle teilt, so hatte uns das Verlangen nach Bildung in verschiedene Richtungen auseinander getrieben; nun waren wir wieder in Athen beieinander, als ob wir es so verabredet hätten, in Wirklichkeit aber, weil Gott es so gefügt hatte.^pDamals verehrte ich meinen großen Basilius, weil ich seine ernste Lebensauffassung sah und die Reife und Klugheit seiner Reden. Aber ich verehrte ihn nicht allein, sondern ich gewann auch andere für ihn, jüngere, die ihn noch nicht kannten. Ich gewann sie, dass sie ihn wertschätzten wie ich. Aber die meisten schenkten ihm gleich ihre Verehrung, weil sie ihn vom Hörensagen schon kannten.^pNach einiger Zeit gestanden wir einander unsere gemeinsame Neigung: die Philosophie, um die es uns ging. Damals schon bedeuteten wir uns alles; wir lebten unter demselben Dach, aßen am gleichen Tisch, arbeiteten zusammen, hatten die gleichen Interessen, und einer weckte stets im andern ein wärmeres und festeres Verlangen.^pGleiche Hoffnung auf Erkenntnis bestimmte uns und hielt den Weg, auf Erkenntnis zu gehen. Aber alle Menschen eifern einander am meisten nach. Und doch gab es zwischen uns keinen Neid mehr. Das war uns ein Wettkampf wichtiger: nicht, wer den ersten Preis gewänne, sondern wer ihn dem andern gewinnen lasse. Denn jeder hielt den Ruhm des andern für seinen eigenen.^pEINE Seele lebte in zwei Körpern. Wenn auch die Philosophen keinen Glauben verdienen, nach denen alles in allem gegenwärtig sein soll, so darf man doch uns glauben, dass jeder im andern und beim andern war.^pUnser beider Wirken und Streben galt der Tugend, auf die künftige Hoffnung hin zu leben und uns so einzustellen, dass wir schon vor dem Scheiden aus dieser Welt Abschied von ihr nahmen. Das stand uns vor Augen, und danach richteten wir das Leben und alles Tun. Wir hielten die Gebote Gottes und eiferten einander an zum Ringen um das Gute. Wenn es nicht zu anmaßend scheint, möchte ich sagen: einer war dem andern Norm und Richtmaß, nach dem er das Rechte vom Falschen unterschied.^pDer eine hat diesen, der andere jenen Zunamen. Er hat ihn von den Eltern geerbt oder ihn durch eigenes Mühen und Arbeiten erworben. Uns aber war es die eine große Wirklichkeit und der eine große Name: Christen zu sein und Christen zu heißen.",
    ...
    "20": {
      ...
      "n2": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hDas treue Zeugnis für Christus^p„Durch viele Drangsale müssen wir in das Reich Gottes gelangen“{1#Apg 14,22}. Wenn die Verfolgungen zahlreich sind, dann sind es ebenso viele Prüfungen; wo viele Kronen winken, da gibt es auch viele Kämpfe. Es ist also gut für dich, dass es viele Verfolger gibt, damit du unter den vielen Nachstellungen den Weg findest, auf dem du die Krone erlangen kannst.^pWir wollen uns das Beispiel des heiligen Sebastian zunutze machen, dessen Gedenktag heute ist. Er ist hier in Mailand geboren. Vielleicht war die Verfolgung schon vorbei, oder sie war noch nicht bis hierher vorgedrungen. Sebastian merkte, dass der Kampf ausblieb oder nachließ. Da reiste er nach Rom, wo wegen des Eifers für den Glauben bittere Verfolgungen entbrannt waren, und dort musste er leiden, das heißt: dort wurde er gekrönt. Dort, wohin er als Gast kam, schlug er den Wohnsitz ewiger Unsterblichkeit auf. Hätte es nur EIN Verfolger gegeben, wäre dieser Märtyrer wohl nicht gekrönt worden.^pAber schlimmer: nicht nur die sind Verfolger, die wir sehen, sondern auch die, welche wir nicht sehen, und diese Verfolger sind zahlreicher. Wie nämlich der eine Verfolgerkönig seine Befehle aussandte und wie es in den einzelnen Städten und Provinzen jedes Mal wieder neue Verfolger gab, so hat auch der Teufel viele Diener unter sich, die nicht nur äußerlich, sondern auch im Innern der einzelnen Seelen Verfolgungen entfachen. Von diesen Verfolgungen heißt es: „Alle, die in der Gemeinschaft mit Christus ein frommes Leben führen wollen, werden verfolgt werden“{2#2°Tim 3,12}. „Alle“ heißt es, keiner ist ausgenommen! Wer könnte auch ausgenommen sein, da der Herr selbst durch die Leiden der Verfolgungen geprüft wurde.^pWie viele stille Märtyrer Christi gibt es täglich, die Jesus Christus bekennen! Dieses Martyrium, dieses treue Zeugnis für Christus kannte der Apostel, wenn er sagte: „Das ist unser Ruhm: das Zeugnis unseres Gewissens!“{3#2°Kor°1,12}",
    ...
    "22": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hVinzenz siegte in dem Sieger über die Welt^pEs heißt: „Euch wurde die Gnade zuteil, für Christus dazusein, also nicht nur, an ihn zu glauben, sondern auch seinetwegen zu leiden“{1#Phil 1,29}. Der Diakon Vinzenz erlangte beides, er erlangte und hatte es. Denn was hätte er gehabt, wenn er es nicht empfangen hätte{2#vgl.°1°Kor°4,7}? Er hatte in seiner Rede Zuversicht und Geduld im Leiden.^pNiemand wage zu predigen auf die Kraft seines eigenen Herzens hin, keiner vertraue auf seine eigene Kraft, wenn er Versuchungen erleiden muss. Denn damit wir Gutes klug sagen, dazu kommt unsere Weisheit von Gott, und damit wir das Böse tapfer erdulden, dafür kommt die Geduld von ihm.^pDenkt daran, wie Jesus Christus im Evangelium seine Jünger ermuntert. Denkt daran, wie der König der Märtyrer seine Soldaten mit geistlichen Waffen versieht, wie er sie auf die Kriege hinweist, wie er Hilfe leistet und Belohnungen aussetzt, wie er zu seinen Jüngern sagt: „In dieser Welt seid ihr in Bedrängnis“, wie sie das erschreckte, wie sie aber getröstet wurden, als er fortfuhr: „Aber habt Mut, ich habe die Welt besiegt“{3#Joh 16,33}.^pWas wundern wir uns also, meine Lieben, wenn Vinzenz in dem siegte, der die Welt besiegt hat? Es heißt: „In dieser Welt seid ihr in Bedrängnis.“ Wenn es uns drückt, soll es uns doch nicht unterdrücken, wenn es uns bestürmt, soll es uns nicht erstürmen. Eine doppelte Schlachtreihe stellt die Welt gegen den Soldaten Christi auf: sie schmeichelt, um zu täuschen, und sie droht, um zu zerbrechen. Uns soll die eigene Lust nicht fesseln und fremde Grausamkeit nicht schrecken! Dann ist die Welt besiegt!^pEine furchtbare Grausamkeit wütete am Leib des Märtyrers, und tiefe Ruhe sprach aus seiner Stimme; harte Peinigung tobte sich aus an den Gliedern, aber große Sicherheit sprach aus seinen Worten, so dass wir auf seltsame Weise meinen möchten, beim Leiden des Vinzenz werde ein anderer gefoltert, nicht der, welcher spricht.^pWirklich, liebe Brüder, so war es, ganz so war es: ein anderer sprach! Denn auch dies hat Christus im Evangelium seinen Zeugen verheißen, für die er solche Kämpfe bereithielt. Denn er sprach: „Macht euch nicht im voraus Sorgen, was ihr sagen sollt. Denn nicht ihr werdet dann reden, sondern der Geist eures Vaters, der in euch spricht“{4#vgl.°Mk 13,11}.^pDas Fleisch also litt, der Geist redete, und indem der Geist redete, wurde die Bosheit besiegt, und nicht nur das: auch die Schwachheit wurde stark.",
    ...
    "3": {
      ...
      "n2": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hLeide für meine Schafe^p„Der Menschensohn ist nicht gekommen, um sich dienen zu lassen, sondern um zu dienen und sein Leben hinzugeben als Lösegeld für viele“{1#Mt 20,28}. Siehe, wie der Herr dient und was für Knechte wir nach seinem Willen sein sollen: „Er gab sein Leben als Lösegeld für viele.“ Er hat uns losgekauft.^pWer von uns wäre fähig, einen andern zu erlösen? Durch sein Blut, durch seinen Tod sind wir vom Tod erlöst. Wir lagen darnieder und wurden durch seine Erniedrigung aufgerichtet. Aber weil wir Christi Glieder sind, müssen wir unseren kleinen Teil zum Heil seiner Glieder beitragen: Er ist das Haupt, wir sind die Glieder.^pDer heilige Johannes macht uns in seinem Brief mahnend auf das Beispiel des Herrn aufmerksam, der gesagt hat: „Wer bei euch groß sein will, der soll euer Diener sein; denn auch der Menschensohn ist nicht gekommen, um sich dienen zu lassen, sondern um zu dienen und sein Leben hinzugeben als Lösegeld für viele.“ Johannes mahnt uns also, Christus ähnlich zu werden: „Christus hat sein Leben für uns gegeben. So müssen auch wir für die Brüder das Leben hingeben“{2#1°Joh°3,16}. Der Herr selbst fragte nach der Auferstehung den Petrus: „Liebst du mich?“ Der erwiderte: „Ja, ich liebe!“ Der Herr sagte es dreimal, und Petrus antwortete dreimal. Und jedes Mal sprach der Herr: „Weide meine Schafe!“{3#Joh 21,15–17}^pNun fährt der Herr fort: „Als du noch jung warst, hast du dich selbst gegürtet und konntest gehen, wohin du wolltest. Wenn du aber alt geworden bist, wirst du deine Hände ausstrecken, und ein anderer wird dich gürten und dich führen, wohin du nicht willst. Das sagte Jesus, um anzudeuten, durch welchen Tod er Gott verherrlichen würde“{4#Joh 21,18.19}. Er kündete Petrus sein Kreuz an und sagte ihm sein Leiden voraus. Auf dem Weg zu diesem Ziel sagte ihm der Herr: „Weide meine Schafe!“ Leide für meine Schafe!",
    ...
    "4": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Deus, qui beátum Rabánum Maurum, ut pópulos veritátem tuam docéret, dono sapiéntiæ illuminásti, córda nostra Spíritus tui claritáte illústra, ut te cognoscámus et quem misísti, Dóminum nostrum Iesum Christum, Fílium tuum,^ORlR"
        },
        "Lesehore": {
    ...
    "14": {
      ...
      "Fulda": {
        "major": {
          ...
          "oration_lat": "Omnípotens et miséricors Deus, qui mártyrem tuum Valentínum epíscopum passiónis suæ torménta superáre fecísti, concéde, ut, qui eius triúmphi diem celebrámus, insuperábiles tua protectióne ab hostis insídiis maneámus.^ORlV"
        },
        "Lesehore": {
    ...
    "24": {
      "eig": {
        ...
        "Vesper": {
          ...
          "antev_lat": "Non vos me elegístis, sed ego elégi vos et pósui vos, ut eátis et fructum afferátis, et fructus vester máneat.^LÖ"
        }
      }
    },
    "25": {
      "n1": {
        ...
        "Vesper": {
          "ant_komm": "Der Herr hat sie zu seiner Braut erwählt auf ewig, in Treue und Erbarmen."
        }
      }
    },
    "27": {
  ...
  "3": {
    ...
    "14": {
      "n1": {
        ...
        "Vesper": {
          "ant_komm": "Preiset sie für den Ertrag ihrer Hände. Lobt ihre Werke an den Toren der Stadt.",
          "ant_komm_lat": "Date ei de fructu mánuum suárum, et laudent eam in portis ópera eius."
        }
      }
    },
    "15": {
      "Fulda": {
        ...
        "Vesper": {
          "ant_komm": "Dank sei dir, Christus, guter Hirte! Du hast mich zur Herrlichkeit geführt; gib auch der Herde, die du mir anvertraut hast, Anteil an deiner Gnade auf ewig.",
          "ant_komm_lat": "Grátias tibi ago, Christe, pastor bone, qui me ad hanc glóriam perdúcere dignátus es; peto ergo ut oves, quas tradidísti mihi, participéntur mecum de grátia tua in sempitérnum."
        }
      },
      "n1": {
        "major": {
    ...
    "2": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_resp2": "damit das Leben Jesu Christi an uns offenbar wird.^Ö",
    ...
    "5": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_resp2": "in unermüdlicher und geduldiger Belehrung.^Ö",
    ...
    "7": {
      "eig": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hDie Liebe Gottes drängt uns^pErwägt im Herzen, liebe Brüder, was der Apostel Paulus sagt: Gott habe in seiner Kirche Apostel, Propheten und Lehrer bestellt{1#vgl.°1°Kor°12,28}, und seid überzeugt dass Gott auch euch in euer Amt eingesetzt hat. Das bezeugt euch derselbe Heilige, wenn er erklärt, es gebe verschiedenen Dienste und verschiedene Kräfte und derselbe Heilige Geist zeige sich in jeder dieser Gaben zum gemeinsamen Nutzen, das heißt zum Nutzen der Kirche{2#vgl.°1°Kor°12,5.11}.^pIhr sollt also nicht an der großen Gnade zweifeln, die ihr erhalten habt: die Knaben zu lehren, ihnen die Frohe Botschaft zu verkünden und sie im Geist der Religion zu erziehen. Es ist ein großes Geschenk Gottes, dass er euch zu einer so heiligen Aufgabe berufen hat.^pDie Schüler, die eurer Sorge anvertraut sind, sollen an eurer ganzen Lehrtätigkeit sehen, dass ihr Diener Gottes seid, da ihr die Aufgabe mit ungeheuchelter Liebe und echter Sorgfalt erfüllt. Auch darum sollt ihr euch eurem Amt verpflichtet fühlen, weil ihr nicht nur Diener Gottes, sondern auch Diener Jesu Christi und der Kirche seid.^pSo sagt der heilige Paulus mahnend, alle seien als Diener Christi zu betrachten, die das Evangelium verkündigen, die den Brief schreiben, den Christus diktiert, „nicht mit Tinte, sondern mit dem Geist des lebendigen Gottes, nicht auf Tafeln aus Stein, sondern – wie auf Tafeln – in Herzen von Fleisch“{3#2°Kor°3,3}, die Herzen der Knaben. Deswegen dränge euch die Liebe Gottes“{4#vgl.°2°Kor°5,14}, weil Jesus Christus „für alle gestorben ist, damit die Lebenden nicht mehr für sich leben, sondern für den, der für sie starb und auferweckt wurde“{5#2°Kor°5,15}. Möge daher eure Sorgfalt und euer Eifer die Schüler bewegen. Mögen sie fühlen, dass Gott sie durch euch ermahnt, weil ihr Gesandte Christi seid.^pFerner müsst ihr der Kirche zeigen, wie sehr ihr sie liebt, und ihr sollt ihr Beweise eurer Gewissenhaftigkeit geben. Denn ihr arbeitet durch die Kirche, den mystischen Leib Christi. Durch eure Arbeitsfreudigkeit zeigt, dass ihr die Menschen, die Gott euch anvertraut hat, liebt, wie Christus die Kirche geliebt hat.",
          "patr_resp1": "Sie brachten Kinder zu Jesus. Die Jünger aber wiesen die Leute ab. Als Jesus das sah, sprach er zu ihnen:",
          "patr_resp2": "Lasst die Kinder zu mir kommen; denn ihnen gehört das Gottesreich.^Ö",
          "patr_resp3": "Wer ein solches Kind in meinem Namen aufnimmt, nimmt mich auf."
        },
        "Laudes": {
    ...
    "21": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_resp2": "Seid wie Menschen, die auf die Rückkehr ihres Herrn warten und ihm öffnen, sobald er kommt und anklopft.^Ö",
    ...
    "25": {
      "eig": {
        "each": {
          ...
          "oration_lat": "Deus, qui beátum Marcum evangelístam tuum evangélicæ prædicatiónis grátia sublimásti, tríbue, quǽsumus, eius nos eruditióne ita profícere, ut vestígia Christi fidéliter sequámur.^ORlV"
        },
        "Laudes": {
          "button": "Hl. Markus",
          "farbe": "r",
          "antev": "Durch die Gnade Jesu Christi wurden den Völkern Lehrer gesandt und Evangelisten, um ihrem Glauben zu dienen.^Ö",
          "antev_lat": "Iesu Christi grátia, credéntibus pópulis doctóres et evangelístæ sunt in ministério fídei missi.^LÖ",
          "hymn_1_lat": 8425.0
        },
        "Vesper": {
          "antev": "In Ewigkeit bleibt das Wort des Herrn, das Evangelium, das euch verkündet worden ist.^Ö",
          "antev_lat": "Verbum Dómini manet in ætérnum: hoc est autem verbum, quod evangelizátum est in vos.^LÖ",
          "hymn_1_lat": 8425.0
        }
      }
    },
  ...
  "5": {
    ...
    "4": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_resp2": "Jedem, der siegt, werde ich gewähren, mit mir auf meinem Thron zu sitzen.^Ö",
    ...
    "5": {
      "Fulda": {
        "major": {
          ...
          "oration_lat": "Beáti Godehárdi memóriam celebrántes súpplices te rogámus, omnípotens Deus, ut, sicut ille tua virtúte éxstitit vitæ monásticæ restaurátor et gregi suo bonus et sápiens pastor, ita nos fácias tuæ voluntáti semper devótos et fratrum dilectióni iúgiter inténtos.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Augustinus (†°430)",
    ...
    "10": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Deus, qui sanctum Ioánnem De Avila clero populóque tuo magístrum præstantíssimum dedísti ob sanctitátem et sedulitátem vitæ, præsta, quǽsumus, ut nostris étiam tempóribus Ecclésia sanctitáte augéscat propter óptimam tuórum ministrórum sedulitátem.^ORlV"
        },
        "Laudes": {
      ...
      "n2": {
        "major": {
          "comm_1": "Mann_Ord",
          "oration": "Barmherziger Gott, du hast uns im heiligen Damian ein leuchtendes Beispiel der Liebe zu den Armen und Verlassenen geschenkt. Auf seine Fürsprache gewähre auch uns die Gnade, den Hilfsbedürftigen und Ausgestoßenen zu dienen, angetrieben durch die Liebe des Herzens deines Sohnes, unseres Herrn Jesus Christus,^ORR",
          "oration_lat": "comm:"
        },
        "Laudes": {
    ...
    "12": {
      ...
      "n2": {
        "major": {
          "comm_1": "MärtSg",
          "oration": "Gott, höre auf die Fürsprache des heiligen Märtyrers Pankratius, dessen Gedenktag wir in Freude feiern. Schenke deiner Kirche Zuversicht und Gelassenheit, damit sie sich in der Bedrängnis nicht fürchte, sondern ausharre im Vertrauen auf Christus Jesus, unseren Herrn und Gott,^ORR",
          "oration_lat": "Lætétur Ecclésia tua, Deus, beáti Pancrátii mártyris confísa suffrágiis, atque, eius précibus gloriósis, et devóta permáneat, et secúra consístat.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Bernhard von Clairvaux (†°1153)",
          "patr_werk": "Aus einer Predigt zu Psalm 91 (90).",
          "patr_text": "^hGott nahe zu sein ist mein Glück^p„Ich bin bei ihm in der Not“{1#Ps 91,15}, spricht Gott, und ich sollte etwas anderes suchen als die Not? „Gott nahe zu sein ist mein Glück“, und nicht nur das: „Ich setze auf Gott, den Herrn, mein Vertrauen“{2#Ps 73,28}. „Ich befreie ihn“, heißt es, „und bringe ihn zu Ehren“{3#Ps 91,15}. „Ich bin bei ihm in der Not.“{4#ebd.}^pEs heißt weiter: „Ich spielte auf seinem Erdenrund, und meine Freude war es, bei den Menschen zu sein“{5#Spr 8,31}: Immanuel, „Gott ist mit uns“{6#Mt 1,23}. Er ist herabgekommen, um nahe bei denen zu sein, die im Herzen betrübt sind, um nahe bei uns zu sein in der Not. Der Tag aber wird kommen, an dem wir „auf den Wolken in die Luft entrückt (werden), dem Herrn entgegen. Dann werden wir immer beim Herrn sein“{7#1°Thess°4,17}. Voraussetzung ist, dass wir uns in der Zwischenzeit bemühen, ihn immer bei uns zu haben, ihn, der uns die Heimat zurückgeben wird; besser: ihn, der unsere Heimat sein wird, vorausgesetzt, dass er jetzt unser Weg ist.^pHerr, es ist gut für mich zu leiden, wenn du nur bei mir bist; besser, als zu herrschen ohne dich, Mahl zu halten ohne dich, geehrt zu werden ohne dich. Herr, es ist besser, dich in der Not zu empfangen, dich im Schmelzofen bei mir zu haben, als ohne dich sogar im Himmel zu sein. „Was habe ich im Himmel außer dir? Neben dir erfreut mich nichts auf der Erde.“{8#Ps 73,25} Der Schmelzofen prüft das Gold, Versuchung und Not den Gerechten{9#vgl.°Spr 17,3; 1°Petr°1,7}. Dort, ja dort wirst du bei ihnen sein, Herr; dort bist du mitten unter denen, die in deinem Namen versammelt sind, wie einst bei den drei jungen Männern{10#vgl.°Dan 3,49}.^pWarum zittern und zögern wir, warum fliehen wir diesen Ofen? Das Feuer wütet, aber der Herr ist bei uns in der Not. „Ist Gott für uns, wer ist dann gegen uns?“{11#Röm 8,31} Wenn er herausreißt, wer wird ihm den Raub abnehmen? Wer könnte seiner Hand etwas entreißen? Schließlich: Wenn er Ehre verleiht, welcher andere kann dann entehren? Wenn er verherrlicht, wer kann dann erniedrigen?^p„Ich sättige ihn mit langem Leben“{12#Ps 91,16}. Es ist, als wollte er geradezu sagen: Ich weiß, wonach er verlangt, wonach er dürstet, was ihm schmeckt. Er hat keinen Geschmack an Gold und Silber, an Vergnügen, Neugierde oder an irgendeiner weltlichen Würde. Alles gilt ihm als Verlust, schätzt er gering, hält er für Unrat{13#vgl.°Phil 3,8}. Er hat sich selbst entäußert und lässt nicht zu, dass ihn irgend etwas ganz für sich beansprucht{14#vgl.°Phil 2,6–7}, was ihn nach seiner Überzeugung nicht ausfüllen kann. Er weiß gut, nach wessen Bild er geschaffen ist, welcher Größe er fähig ist, und gibt nicht zu, dass er im Kleinen wächst, aber im Größeren abnimmt.^pDaher also: „Ich sättige ihn mit langem Leben“{15#Ps 91,16}. Nur das wahre Licht kann ihn erquicken, nur das Ewige ihn ausfüllen. Denn jenes lange Leben kennt kein Ende, jener Glanz keinen Untergang, jene Sättigung keinen Überdruss.",
          "patr_resp1": "Er stritt bis zum Tod für das Gesetz seines Gottes und fürchtete sich nicht vor den Worten der Gottlosen,",
          "patr_resp2": "denn er war auf einen festen Felsen gegründet.^Ö",
          "patr_resp3": "Er hat das Leben der Welt geringgeachtet und ist zum Reich des Himmels gelangt."
        },
    ...
    "13": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Deus, qui Genetrícem Fílii tui Matrem quoque nostram constituísti, concéde nobis, ut, in pæniténtia et oratióne pro mundi salúte perseverántes, in dies valeámus regnum Christi efficácius promovére.^ORlV"
        },
        "Laudes": {
    ...
    "20": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Deus, qui beáto Bernardíno presbýtero sancti nóminis Iesu amórem exímium tribuísti, eius méritis precibúsque concéde, ut spíritus nos semper tuæ dilectiónis accéndat.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Bernhardin von Siena (†°1444)",
          "patr_werk": "Aus einer Predigt über den Namen Jesus.",
          "patr_text": "^hDer Name Jesus ist der Glanz der Prediger^pDer Name Jesus ist der Glanz der Prediger, weil er das Verkündigen und das Hören des Gotteswortes zum hellen Leuchten bringt. Woher, meinst du, kommt auf dem ganzen Erdkreis so schnell und glühend das Licht des Glaubens, wenn nicht dadurch, dass Jesus verkündigt wird{1#vgl.°1°Kor°2,2}? Hat Gott uns nicht durch das Licht und die Lieblichkeit dieses Namens „in sein wunderbares Licht gerufen“{2#1°Petr°2,9}? Wir sind erleuchtet, wir schauen das Licht in seinem Licht{3#vgl.°Ps 36,10}. Darum sagt uns der Apostel mit Recht: „Einst wart ihr Finsternis, jetzt aber seid ihr durch den Herrn Licht geworden. Lebt als Kinder des Lichts!“{4#Eph 5,8} Daher muss dieser Name verkündet werden, damit er leuchtet und nicht verschwiegen wird.^pAber auch in der Predigt darf der Name nicht mit einem unreinen Herzen und einem befleckten Mund ausgesprochen werden. Er muss in einem erlesenen Gefäß aufbewahrt und aus ihm heraus verkündet werden. Darum sagt der Herr vom Apostel: Dieser Mann ist mir ein erlesenes Gefäß, damit er meinen Namen vor Völker und Könige und die Söhne Israels trägt{5#vgl.°Apg 9,15}. Ein mir erlesenes Gefäß, sagt er, in dem eine kostbare Flüssigkeit zum Kauf angeboten wird. Sie reizt zum Trinken, da sie in auserwählten Gefäßen glänzt und leuchtet: „damit es meinen Namen trägt“{6#vgl.°Apg 9,15}, wie Gott sagt.^pWie nach dem Abernten der Äcker die trockenen und nutzlosen Dornsträucher angezündet und im Feuer verbrannt werden und wie beim Aufgehen der Sonnenstrahlen die Finsternis vertrieben wird und die Diebe, die nächtlichen Streuner und Einbrecher sich verstecken, so war es, als Paulus den Völkern predigte: ein lautes Donnern, ein Blitzen, heller als Feuer, heller als die aufgehende Sonne. Der Unglaube wurde verzehrt, die Falschheit verging, die Wahrheit leuchtete auf: wie bei einer Wachskerze, die sich im Brand der Flamme verflüssigt.^pPaulus verbreitete nämlich überall den Namen Jesus in Worten und Briefen, durch seine Wunder und sein Beispiel. Er lobte den Namen Jesus beharrlich, er lobte ihn in Danksagung{7#vgl.°Sir 51,15 Vg}.^pDiesen Namen trug der Apostel „vor Völker und Könige und die Söhne Israels“{8#vgl.°Apg 9,15} wie ein Licht. Er erleuchtete damit die Völker und rief überall: „Die Nacht ist vorgerückt, der Tag ist nahe. Darum lasst uns ablegen die Werke der Finsternis und anlegen die Waffen des Lichts! Lasst uns ehrenhaft leben wie am Tage, ohne maßloses Essen und Trinken, ohne Unzucht und Ausschweifung, ohne Streit und Eifersucht“{9#Röm 13,12–13}. Er zeigte allen die brennende und strahlende Lampe auf dem Leuchter{10#vgl.°Mk 4,27} und verkündigte überall „Jesus Christus, und zwar als den Gekreuzigten“{11#1°Kor°2,2}.^pDarum jubelt die Kirche, seine Braut, immer auf sein Zeugnis gestützt, mit dem Propheten: „Gott, du hast mich gelehrt von Jugend auf, und noch heute verkünde ich dein wunderbares Walten“{12#Ps 71,17}. ‚Noch heute‘, das heißt: immer. Der Prophet ermuntert auch: „Singt dem Herrn und preist seinen Namen, verkündet sein Heil von Tag zu Tag“{13#Ps 96,2}: Jesus, unsern Erlöser!",
          "patr_resp1": "Ich will jubeln und an dir mich freuen;",
          "patr_resp2": "für dich, du Höchster, will ich singen und spielen.^Ö",
    ...
    "21": {
      ...
      "n2": {
        "major": {
          ...
          "oration_lat": "Omnípotens ætérne Deus, qui beátos Christóphorum, presbýterum, et sócios Christo Regi usque ad martýrium fidéles effecísti, eórum intercessióne nobis concéde, ut, in veræ fídei perseverántes confessióne amóris tui mandátis semper inhærére valeámus.^ORlV"
        },
        "Laudes": {
    ...
    "22": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Largíre nobis, quǽsumus, Dómine, sapiéntiam crucis et fortitúdinem, quibus beátam Ritam ditáre dignátus es, ut, in tribulatióne cum Christo patiéntes, pascháli eius mystério intímius participáre valeámus.^ORlR"
        },
        "Laudes": {
    ...
    "24": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Omnípotens et miséricors Deus, qui ad defensiónem pópuli christiáni in beatíssima Vírgine María perpétuum auxílium mirabíiter constituísti, concéde propítius, ut, tali præsídio muníti certántes in vita, victóriam de hoste malígno cónsequi valeámus in morte.^ORlV"
        },
        "Laudes": {
    ...
    "26": {
      "eig": {
        "major": {
          ...
          "oration_lat": "Deus, qui fidéles tibi servos sanctitátis glória sublimáre non desístis, concéde propítius, ut illo nos igne Spíritus Sanctus inflámmet, quo beáti Philíppi cor mirabíliter penetrávit.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Augustinus (†°430)",
          "patr_werk": "Aus einer Predigt.",
    ...
    "27": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Deus, qui beáti Augustíni epíscopi prædicatióne Anglórum gentes ad Evangélium perduxísti, tríbue, quǽsumus, ut eius labórum fructus in Ecclésia tua perénni fecunditáte persístant."
        },
        "Lesehore": {
          "patr_autor": "Gregor der Große (†°604)",
          "patr_werk": "Aus einem Brief.",
          "patr_text": "^hDas Volk der Angeln ist vom Licht des Glaubens erhellt^p„Ehre sei Gott in der Höhe und Friede auf Erden den Menschen seiner Gnade“{1#Messbuch: Gloria; vgl.°Lk 2,14}; denn das Weizenkorn ist in die Erde gefallen und gestorben{2#vgl.°Joh°12,24}, um nicht bloß im Himmel zu herrschen. Durch seinen Tod leben wir, durch seine Sehwachheit werden wir stark, durch sein Leiden werden wir den Leiden entrissen. Aus Liebe zu ihm suchten wir in England Brüder, die wir nicht kannten; durch seine Gnade fanden wir sie, die wir suchten, ohne sie zu kennen.^pWer vermöchte die Freude zu beschreiben, die in den Herzen aller Gläubigen hervorgerufen wurde, als das Geschlecht der Angeln durch das Gnadenwirken des allmächtigen Gottes und durch dein Mühen, lieber Bruder, die Finsternis des Irrtums vertrieben hat und vom Licht des Glaubens erhellt worden ist. Untadeligen Geistes tritt es nun die Götzenbilder mit Füßen, denen es früher in sinnloser Furcht unterworfen war. Es wirft sich reinen Herzens nieder vor dem allmächtigen Gott. Es lässt sich binden durch die Regeln der heiligen Verkündigung, die es vor dem Rückfall in die Sünde bewahren. Es gehorcht den Geboten Gottes und wächst in der Erkenntnis. Im Gebet beugt es sich nieder zur Erde, damit sein Geist nicht am Boden liegt.^pWessen Werk ist das, wenn nicht das Werk dessen, der da spricht: „Mein Vater ist noch immer am Werk, und auch ich bin am Werk“{3#Joh 5,17}. Um zu zeigen, dass sich die Welt nicht durch die Weisheit der Menschen, sondern durch seine Kraft bekehrt, wählte Gott als seine Prediger, die er in die Welt sandte, ungebildete Männer aus. Das tut er auch jetzt noch, denn er lässt im Stamm der Angeln durch schwache Menschen Großes wirken.^pAber in diesem Geschenk vom Himmel, liebe Brüder, ist etwas, was uns neben der großen Freude mit sehr großer Furcht erfüllen muss. Ich weiß nämlich, dass der allmächtige Gott durch deine Liebe in dem Stamm, den er erwählt hat, große Wunder gewirkt hat. Darum ist es notwendig, dass du dich über das Geschenk des Himmels freust in großer Furcht und dass du dich fürchtest in Freude. Freuen sollst du dich, weil die Seelen der Angeln durch die äußeren Wunder von der inneren Gnade angezogen werden. Aber fürchten sollst du dich davor, der schwache Geist möge sich am Ende angesichts der Zeichen, die geschehen, anmaßend erheben; was ihm äußerlich Ehren einbringt, möchte ihn durch eitlen Ruhm innerlich zu Fall bringen.^pWir dürfen nicht vergessen: Als die Jünger voll Freude vom Predigen zurückkamen, sagten sie zu ihrem himmlischen Meister: „Herr, sogar die Dämonen gehorchen uns, wenn wir deinen Namen aussprechen.“ Darauf bekamen sie zu hören: „Freut euch nicht darüber, dass euch die Geister gehorchen, sondern freut euch darüber, dass eure Namen im Himmel verzeichnet sind.“{4#Lk 10,17.20}",
          "patr_resp1": "Ahmt mich nach und achtet auf jene, die nach meinem Vorbild leben.",
          "patr_resp2": "Und der Gott des Friedens wird mit euch sein.^Ö",
    ...
    "29": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Deus, qui Ecclésiam tuam regéndam beáto Paulo papæ commisísti, strénuo Fílii tui Evangélii apóstolo, præsta, quǽsumus, ut, ab eius institútis illumináti, ad civílem amóris cultum in mundum dilatándum tibi collaboráre valeámus."
        },
        "Laudes": {
          "button": "Hl. Paul VI.",
  ...
  "6": {
    "1": {
      "eig": {
        ...
        "Vesper": {
          ...
          "antev_lat": "Mihi statim in ánima ignis accénsus est, meque amor invásit prophetárum et hóminum illórum, qui Christi sunt amíci.^LÖ"
        }
      }
    },
    "2": {
    ...
    "3": {
      "eig": {
        ...
        "Lesehore": {
          ...
          "patr_resp2": "Welch erhabene Herrlichkeit, in der Gegenwart Gottes zu kämpfen und von Christus den Siegeskranz zu empfangen!^Ö",
    ...
    "6": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Deus, qui beátum Norbértum epíscopum Ecclésiæ tuæ oratióne ac pastoráli zelo minístrum exímium effecísti, præsta, quǽsumus, ut, eius interveniénte suffrágio, fidélium grex pastóres iuxta cor tuum et salutária páscua semper invéniat.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "LEER",
          ...
          "patr_resp2": "verkünde das Wort zu gelegener und ungelegener Zeit.^Ö",
    ...
    "7": {
      "Fulda": {
        ...
        "Laudes": {
          ...
          "antev_lat": "Qui vitæ ætérnæ semen cum sancto Bonifátio late divulgavérunt, iis cor erat unum et ánima una atque una eadémque palma martyrii.^LÖ"
        },
        "Vesper": {
          ...
          "antev_lat": "Dixit beátus Bonifátius sóciis suis: Ne terreámini ab his, qui occídunt corpus, ánimam autem necáre non possunt; sed gaudéte in Dómino et constánter subíte mortis artículum, ut regnáre cum Christo possítis in ævum.^LÖ"
        }
      }
    },
    "9": {
    ...
    "11": {
      "eig": {
        ...
        "Laudes": {
          "button": "Hl. Barnabas",
          "farbe": "r",
          "antev": "Barnabas zog nach Tarsus. Er suchte Saulus auf und nahm ihn mit nach Antiochia. Dort wirkten sie in der Gemeinde und verkündeten das Wort des Herrn.^Ö",
        ...
        "Vesper": {
          "antev": "Die ganze Versammlung schwieg. Und Barnabas und Paulus erzählten, welch große Zeichen und Wunder Gott durch sie getan hatte unter den Heiden.^Ö",
    ...
    "13": {
      "eig": {
        "major": {
          ...
          "oration_lat": "Omnípotens sempitérne Deus, qui pópulo tuo beátum Antónium prædicatórem insígnem dedísti, eúmque in necessitátibus intercessórem, concéde, ut, eius auxílio, christiánæ vitæ documénta sectántes, in ómnibus adversitátibus te subveniéntem sentiámus.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Antonius von Padua († 1231)",
          "patr_werk": "Aus einer Predigt über die Aufgabe des Predigers.",
          "patr_text": "^hDie Rede hat Leben, wenn die Taten sprechen^pWer vom Heiligen Geist erfüllt ist, redet in vielen Sprachen. Die vielen Sprachen sind ein vielfältiges Zeugnis von Jesus Christus. Solche Sprachen sind: Demut, Armut, Geduld und Gehorsam. In ihnen reden wir, wenn wir sie anderen an uns sichtbar machen. Die Rede hat Leben, wenn die Taten sprechen. Ich bitte: Schluss mit den Worten, die Taten sollen sprechen! Wir sind voll von Worten und leer an Werken und darum von Gott verworfen. Denn er verfluchte den Feigenbaum, an dem er keine Frucht, sondern nur Blätter fand{1#vgl.°Mt 21,9}. Gregor sagt: Es ist ein Gesetz für den Prediger, dass er tut, was er predigt. Vergeblich rühmt sich der Gesetzeskenntnis, wer durch seine Taten zunichtemacht, was er lehrt.^pDie Apostel „redeten, wie es der Geist ihnen eingab“{2#Apg 2,4}. Wohl dem, der redet, wie es der Geist ihm eingibt, und nicht, wie es sein eigenes Herz ihm sagt. Es gibt Prediger, die aus ihrem eigenen Geist reden, die Worte anderer stehlen, sie für die ihrigen ausgeben und sich selbst zuschreiben. Von ihnen und ähnlichen sagt der Herr bei Jeremia: „Nun gehe ich gegen die Propheten vor – Spruch des Herrn –, die einander meine Worte stehlen. Nun gehe ich gegen die Propheten vor – Spruch des Herrn –, die ihre Zunge gebrauchen, um Sprüche zu machen. Ja, nun gehe ich vor gegen die Propheten mit ihren erlogenen Träumen – Spruch des Herrn; sie erzählen die Träume und verführen mein Volk durch ihre Lügen und ihr freches Geschwätz. Ich aber habe sie weder gesandt noch beauftragt, und sie sind diesem Volk ganz unnütz – Spruch des Herrn.“{3#Jer 23,30-32}^pLasst uns also reden, wie es uns der Heilige Geist eingibt. Wir wollen ihn demütig und ergeben bitten, uns seine Gnade einzugießen, damit wir den Pfingsttag mit allen fünf Sinnen und in der Erfüllung der zehn Gebote feiern, dass wir durch die Feuerzungen des Bekenntnisses entzündet werden und dass wir, entzündet und erleuchtet, im Glanz der Heiligen den dreieinigen Gott schauen dürfen.",
    ...
    "19": {
      "n1": {
        "major": {
          "comm_1": "Mann_Ord",
          "oration": "Gott, du Freund der Heiligen, du hast den Abt Romuald berufen, einen Orden für Mönche zu gründen, die in strenger Einsamkeit leben. Schenke uns die Gnade, uns selbst zu verleugnen und Christus nachzufolgen, damit wir mit ihm in die Herrlichkeit des Himmels gelangen,^ORR",
          "oration_lat": "Deus, qui per beátum Romuáldum in Ecclésia tua eremíticam vitam renovásti, concéde, ut, nosmetípsos abnegántes et Christum sequéntes, felíciter ad cæléstia regna mereámur ascéndere.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Petrus Damiani (†°1072)",
    ...
    "27": {
      "Fulda": {
        "major": {
          ...
          "oration_lat": "Deus, cuius ope confísus beátus Heimerádus inópiam hominúmque derísum patiénter sustínuit, ipsíus nobis intercessióne concéde, ut advérsa quæque superántes, peregrinatióne fidéli ad te perveníre possímus.^ORlV"
        },
        "Lesehore": {
    ...
    "28": {
      "eig": {
        "major": {
          ...
          "oration_lat": "Deus, qui beáto Irenæo epíscopo tribuísti, ut veritátem doctrínæ pacémque Ecclésiæ felíciter, confirmáret, concéde, quǽsumus, eius intercessióne, ut nos, fide et caritáte renováti, ad unitátem concordiámque fovéndam semper simus inténti.^ORlV"
        },
        "Lesehore": {
  ...
  "7": {
    "4": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hGott bereitet Großes denen, die ihn lieben^p„Welche Freuden, welche Wonnen den Gesegneten Gottes, die an seine rechte Seite gestellt werden, beschieden sind, das“ – so sagte Bischof Ulrich – „soll man sich immer vorstellen, so gut es der menschliche Geist nur immer vermag. Darüber steht ja geschrieben: ‚Was kein Auge gesehen und kein Ohr gehört hat, was keinem Menschen in den Sinn gekommen ist: das Große, das Gott denen bereitet hat, die ihn lieben‘{1#1°Kor°2,9}.^pDort strahlen in unsagbarem Glanz die lobpreisenden Chöre der Engel; dort freut sich, belohnt mit verdienter Ehre, die erhabene Schar der Patriarchen; der wahrheitkündende Stand der Propheten dankt Gott ohne Unterlass, vollkommen erfüllt sind nun ihre Worte; der Richter-Chor der Apostel frohlockt dort in Ewigkeit, sie haben den Lohn empfangen, der ihnen verheißen war von Anfang an.^lIm Schmuck ihrer Siegespalme erfreuen sich ewigen Trostes die Märtyrer; im Lob Gottes Verharren die Bekenner, vielfachen Lohn haben sie empfangen.^lDort wird den Jungfrauen hundertfältige Frucht zurückerstattet, und sie haben im Überfluss; die Witwen und Waisen werden belohnt, sechzigfache Frucht{2#vgl.°Mt 13,8} wird ihnen zurückerstattet.^lDort werden mit allen, die hungern und dürsten nach der Gerechtigkeit, die Mönche ohne Unterlass Gott loben, der Lohn ihres irdischen Verzichts wird ihnen zuteil, ihre Sehnsucht ist erfüllt, ihr Hunger gestillt.^lDort werden die Büßer, befreit von der Last ihrer Sünden, sich mitfreuen und Gott loben ohne Ende.^lDort werden die Kleinen, die in weißen Kleidern dem Lamm folgen{3#vgl.°Offb 14,4}, sich vor dem Thron mit den Engeln vereinen und im Lob Gottes nimmermehr verstummen.^lDort strahlt, erhöht über die Chöre der Engel, die glorreiche Jungfrau und Gottesmutter Maria in unermesslicher Reinheit und Schönheit, alle mit Freude erfüllend.^lDort werden die Gerechten wie die Sonne leuchten{4#vgl.°Mt 13,43}, und alle Heiligen werden ihren Schöpfer und den Schöpfer aller Wesenheit in seinem Licht von Angesicht zu Angesicht schauen und sich freuen. Und er nimmt von ihnen alle Angst, Trauer und Mühsal und alles Leid{5#vgl.°Offb 21,4}.^pIn diesem Reich bedarf es des Lichtes der Sonne nicht mehr, noch des Mondes{6#vgl.°Offb 21,23} und der Sterne. Hunger und Durst wird niemand mehr plagen, noch Kälte und Hitze einen belästigen{7#vgl.°Offb 7,16}, noch Krankheit und Schmerz einen befallen. Man braucht nicht die Leiden nahenden Alters zu fürchten, denn wie die Leiber der Toten am Tag des Gerichts in der Fülle der Jahre Christi auferstehen, in derselben Kraft und Schönheit werden sie ewig bleiben. So wie die Engel in ihrem ursprünglichen Stand immer bleiben werden, so bleiben auch die Menschen nach ihrer Auferstehung rein und unverändert und wohnen in der Stadt unseres Gottes, die erbaut ist auf seinem heiligen Berg.^pDie Mauer hat zwölf Grundsteine, prächtig wie zwölf Edelsteine{8#vgl.°Offb 21,14.19}. Diese zwölf Edelsteine bedeuten die Apostel, auf deren festem Fundament die Kirche ruht, wie der Welterlöser zum heiligen Petrus sagt: ‚Du bist Petrus, und auf diesen Felsen werde ich meine Kirche bauen‘{9#Mt 16,16}. Indem er das zu Petrus sagte, tat er allen Aposteln kund, dass auf sie seine Kirche gebaut werden solle, auf sie, deren Botschaft in die ganze Welt hinausging und deren Wort bis an die Enden der Erde gelangte{10#vgl.°Ps 19,5}.^pWenn nun die Apostel das Fundament des Hauses Gottes sind und wenn die ganze Christenheit der Bau des Tempels sein soll – wie der Herr sagt: ‚Der Tempel Gottes ist heilig, und der seid ihr‘{11#1°Kor°3,17}, und: ‚Ihr seid Gottes Bau‘{12#1°Kor°3,9} usw. –, dann lasst uns alle mit ganzer Kraft danach trachten, uns dem anzuschließen, der uns erbaut und in uns wohnt, auf dass wir mit seiner Gnade würdig seien, aufgebaut zu werden auf dem Fundament, das unsere Lehrer sind, um so als auserwählte Steine, als eingefügt in die Stände der Kirche befunden zu werden und unseren Schöpfer und Erlöser, den Richter der Lebenden und der Toten, dereinst von Angesicht zu Angesicht schauen und mit ihnen loben zu dürfen in alle Ewigkeit. Amen.“",
      ...
      "n2": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hSelig, die Frieden stiften^pDer Evangelist sagt: „Selig, die Frieden stiften; denn sie werden Söhne Gottes genannt werden“{1#Mt 5,9}. Meine Lieben, der Friede ist es, der von der Knechtschaft befreit. Er verleiht den edlen Namen, verwandelt vor Gott mit dem Stand auch die Person: er macht aus dem Diener den Sohn und aus dem Knecht den Freien. Friede unter den Brüdern ist der Wille Gottes und die Freude Christi.^pDer Friede ist der Ursprung der Liebe; er ist das Band der Einheit und ein deutliches Zeichen reiner Gesinnung. Diese kann von Gott erbitten, was sie will; was immer sie wünscht, erbittet sie, und um was sie bittet, das erhält sie. Es ist ein Gebot des Königs, den Frieden zu wahren, da Christus, der Herr, sagt: „Frieden hinterlasse ich euch, meinen Frieden gebe ich euch“{2#Joh 14,27}. Das bedeutet: In Frieden entlasse ich euch, in Frieden will ich euch wiederfinden. Bei seinem Scheiden wollte er geben, was er bei seiner Wiederkehr in allen zu finden wünschte.^pGebot des Himmels ist es, zu bewahren, was er gegeben hat. Es ist sein Wort: Ich will finden, was ich hinterlassen habe. Frieden mit der Wurzel zu pflanzen ist Sache Gottes, ihn ganz zu entwurzeln Sache des Feindes. Denn wie die Bruderliebe von Gott kommt, so der Hass vom Teufel. Daher ist der Hass zu verdammen. Denn in der Heiligen Schrift steht: „Jeder, der seinen Bruder hasst, ist ein Mörder“{3#1°Joh°3,15}.^pIhr seht, liebe Brüder, warum wir den Frieden lieben und die Eintracht hochschätzen müssen: Sie bringen Liebe hervor und geben ihr Nahrung. Ihr wisst, nach dem Apostel „ist Gott die Liebe“{4#1°Joh°4,16}. Wer also die Liebe nicht hat, ist ohne Gott.^pLasst uns die Gebote halten, Brüder, denn sie sind Leben. Die Brüderlichkeit bleibe eingebunden in tiefen Frieden. Sie fessele sich durch das heilbringende Band der Liebe und gegenseitiger Zuneigung, die „viele Sünden zudeckt“{5#1°Petr°4,8}. Wir müssen die Liebe mit der ganzen Sehnsucht umfangen, da sie so hohe Güter als Lohn gewinnen kann. Mehr als alle Tugenden ist der Friede zu wahren, denn im Frieden ist immer Gott.^pLiebt den Frieden, und alles ist still: So bewahrt ihr Lohn für uns und Freude für euch, liebe Brüder, damit die Kirche Gottes, in der Einheit des Friedens begründet, die in Christus vollendete Ordnung festhält.",
    ...
    "5": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hDie Schüler des Apostels Paulus^p„Wir stehen als Toren da um Christi willen“{1#1°Kor°4,10}; das sagte der heilige Paulus, unser Führer und Schutzherr, von sich und den übrigen Aposteln wie auch von allen, die sich zu einer christlichen und apostolischen Ordnung bekennen. Aber es gibt keinen Grund, liebe Brüder, sich zu wundern oder sich zu fürchten; „denn ein Jünger steht nicht über seinem Meister und ein Sklave nicht über seinem Herrn“{2#Mt 10,24}.^pUnsere Gegner leisten sich einen schlechten, uns aber einen guten Dienst. Sie verschaffen uns Kronen großer Herrlichkeit, für sich aber fordern sie den Zorn Gottes heraus. Wir müssen mit ihnen Erbarmen haben und sie lieben, statt sie zu verabscheuen und zu hassen. Ja, wir müssen für sie beten und dürfen uns nicht vom Bösen besiegen lassen, sondern müssen das Böse durch das Gute besiegen{3#vgl.°Röm 12,21}. Wie uns der Apostel mahnt, müssen wir „glühende Kohlen“ brennender Liebe „auf ihr Haupt sammeln“{4#vgl.°Röm 12,20}, damit sie unsere Geduld sehen, sich zu fruchtbringenderem Leben bekehren und in Gottesliebe entbrennen.^pUns hat Gott in seiner Huld trotz unserer Unwürdigkeit aus der Welt erwählt, damit wir ihm dienen, von Tugend zu Tugend fortschreiten und durch unsere Ausdauer reiche Frucht der Liebe bringen{5#vgl.°Lk 8,15} und nicht nur wegen der Hoffnung auf die Herrlichkeit der Kinder Gottes jubeln, sondern auch wegen unserer Bedrängnis{6#vgl.°Röm 5,3}.^p„Seht doch auf eure Berufung, Brüder!“{7#1°Kor°1,26} Wenn wir sie ernstlich bedenken, werden wir erkennen, dass dies ihr Sinn und ihre Forderung ist. Da wir begonnen haben, den Spuren der heiligen Apostel und der anderen Streiter Christi, wenn auch nur von weitem, zu folgen, dürfen wir uns auch nicht weigern, an ihren Leiden teilzunehmen. „Lasst uns mit Ausdauer in dem Wettkampf laufen, der uns aufgetragen ist, und dabei auf Jesus blicken, den Urheber und Vollender des Glaubens“{8#Hebr 12,1–2}.",
    ...
    "8": {
      "n1": {
        "major": {
          "comm_1": "MärtPl",
          "comm_2": "Hirten",
          "oration": "Allmächtiger und barmherziger Gott, durch die Missionsarbeit des heiligen Kilian und seiner Gefährten hast du im fränkischen Land den christlichen Glauben grundgelegt. Auf die Fürsprache dieser Glaubensboten festige uns alle in der Treue zu unserem Herrn Jesus Christus,^ORR",
          "oration_lat": "Omnípotens et miséricors Deus, qui beáti Kiliáni et sociórum éius apostólico labóre christiánæ religiónis fundaménta in terra Francórum iácere dignátus es, fac, ut, eórum intercessióne, in fídei stabilitáte firmémur.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Caesarius von Arles (†°542)",
          "patr_werk": "Aus einer Predigt über die Aufgabe des priesterlichen Amtes.",
          "patr_text": "^hVerkünde allen das Wort Gottes^pEine unendlich schwere Bürde lastet auf den Schultern aller Priester. Wenn wir das beherzigen, wird uns bewusst, wie schwer die Worte wiegen, mit denen der Herr durch den Propheten besonders die Priester aufschreckt: „Rufe, halte dich nicht zurück! Lass deine Stimme ertönen wie eine Posaune!“{1#Jes 58,1} Und weiter: „Wenn du den Schuldigen warnst, hast du dein Leben gerettet. Wenn du ihn aber nicht warnst, wird er seiner Sünde wegen sterben, von dir aber fordere ich Rechenschaft für sein Blut“{2#vgl.°Ez 3,19.18}. Und der Apostel sagt: „Denkt daran, dass ich drei Jahre lang Tag und Nacht nicht aufgehört habe, unter Tränen jeden einzelnen zu ermahnen“{3#Apg 20,31}.^pWer muss über diese Worte nicht zutiefst erschrecken? Um vor Gott zu bestehen, verkündete Paulus Tag und Nacht den ihm anvertrauten Völkern das Wort des Herrn. Dürfen wir es da versäumen, den Schafen des Herrn das Salz der Lehre zu reichen?^pSeiner Verantwortung bewusst, sagt daher der Apostel Paulus in diesem Zusammenhang: „Ich bin an keines Menschen Blut schuldig“{4#Apg 20,27}. An welchem Blut fühlt sich der Apostel unschuldig? An dem, das der Prophet meint, wenn er, um uns in heilsame Furcht zu versetzen, warnt: „Wenn du den Schuldigen nicht warnst, werde ich von dir Rechenschaft fordern für sein Blut“{5#vgl.°Ez 3,18}. Das Blut der Seele, nicht des Leibes!^pNach den Worten „Ich bin an keines Menschen Blut schuldig“ fügt er schließlich hinzu, als ob ihn jemand gefragt hätte, an welchem Blut er unschuldig sei: „Ich habe mich der Pflicht nicht entzogen, euch den ganzen Willen Gottes zu verkünden“{6#Apg 20,27}. Einer geistlichen und himmlischen Posaune vergleichbar, ermahnt er daher seinen Schüler in banger Sorge: „Ich beschwöre dich bei Gott und bei Christus Jesus, dem kommenden Richter der Lebenden und der Toten, bei seinem Erscheinen und bei seinem Reich“{7#2°Tim 4,1}. Wie wenn man ihn gefragt hätte, was er mit dieser beschwörenden und furchterregenden Einleitung sagen wolle, fügt er sogleich hinzu: „Verkünde das Wort, tritt dafür ein, ob man es hören will oder nicht!“{8#2°Tim 4,2} Denen, die wollen, muss man es geben; denen, die nicht wollen, aufdrängen.^pDas möchte ich euch deshalb so ans Herz legen, weil wir sonst fürchten müssen, dass sich manche von den uns Anvertrauten am Gerichtstag gegen uns erheben und uns vorwerfen, wir hätten sie weder vom Bösen abgehalten noch zum Guten angespornt. Auch an einer anderen Stelle sagt der Apostel: „Lies ihnen eifrig (aus der Schrift) vor, ermahne und belehre sie!“{9#vgl.°1°Tim 4,13} Ja, sein Ruf erschreckt uns, wenn es heißt: „Keiner, der in den Krieg zieht, lässt sich in Alltagsgeschäfte verwickeln, denn er will, dass der Heerführer mit ihm zufrieden ist“{10#2°Tim 2,4}. In heilsame Furcht sollen uns daher auch diese Worte versetzen: „Über die Hindernisse der Welt sind sie ins Unglück gestürzt“{11#vgl.°1°Tim 6,9}.^pGewiss, die Erde nimmt uns in Anspruch: wir sind ihr verpflichtet, wir können uns ihr nie ganz entziehen. Aber soweit wir können, wollen wir uns davon freihalten, damit wir immer für die Lesung Zeit haben und die Weisung befolgen können, die der Herr an den heiligen Petrus richtete, als er zum dritten Mal zu ihm sagte: „Weide meine Schafe!“{12#Joh 21,16} Die Bischöfe heißen nämlich deshalb „Wächter“, weil sie wie auf einem Turm eine höhere Stelle einnehmen und weil sie auf den Stufen des Altares stehen. Auf diesem Platz tragen sie Verantwortung für die Stadt und den Acker Gottes, das heißt: für die ganze Kirche.",
    ...
    "9": {
      "Fulda": {
        ...
        "Laudes": {
          "button": "Übertragung des hl. Bonifatius",
          "farbe": "r"
        }
      },
      "n1": {
    ...
    "10": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hNehmt mein Joch auf euch!^pDas Kreuz des Herrn zog die Augen der Könige nach oben, so dass sie himmelwärts Christus suchten. Sie legten ab den Zaum der Gottlosigkeit, legten an den Zügel der Gottesfürchtigkeit und des Glaubens und folgten dem, der sie einlud: „Nehmt mein Joch auf euch! Denn mein Joch drückt nicht, und meine Last ist leicht“{1#Mt 11,29.30}. Das Prophetenwort hat sich also bewahrheitet: „Könige wandern zu deinem strahlenden Glanz“{2#Jes 60,3}. Ja gewiss, sie ‚wandern‘ nicht mehr in der Rüstung ihrer Kriegswaffen, sondern ihrer Verdienste; nicht mehr mit dem Purpurmantel angetan, sondern ins Gewand der Glorie gehüllt.^pWenn sie schon hier ihre Freude daran hatten, viele freizusprechen, wieviel mehr wird sie dort die Rückerinnerung an ihre vielen Begnadigungen mit Freude erfüllen? Dort freuen sie sich des strahlenden Lichtes, dort haben sie weit bessere Wohnungen erlangt, als sie hier besaßen. Sie können sprechen: „Israel, wie groß ist die Wohnung Gottes, wie weit das Gebiet seiner Herrschaft!“{3#Bar 3,24}^pNachdem sie die denkbar größten Mühen und Beschwerden überstanden, können sie zueinander sprechen: „Gut ist es für den Mann, ein Joch zu tragen in der Jugend. Er sitze einsam und schweige, wenn der Herr es ihm auflegt“{4#Klgl 3,27–28}. Nur wer das schwere Joch von Jugend auf getragen, erfreut sich nämlich nachmals der Ruhe. Es wird ihm ein besonderer Ruheplatz zum Besitz angewiesen, und er jubelt: „Du allein, Herr, lässt mich sorglos ruhen“{5#Ps 4,9}.",
    ...
    "12": {
      "n1": {
        "major": {
          ...
          "oration_lat": "comm:Effúnde super nos, Dómine, spíritum agnitiónis et dilectiónis tuæ, quo fámulos tuos Ludovícum et Cæcíliam implevísti, ut, sédula eórum imitatióne tibi sincére obsequéntes, fide et ópere placeámus.^ORlV"
        },
        "Laudes": {
    ...
    "31": {
      "eig": {
        ...
        "Lesehore": {
          ...
          "patr_resp1": "Wer redet, rede Worte, die Gott ihm gibt; wer dient, diene aus der Kraft, die Gott verleiht.",
    ...
    "13": {
      "Fulda": {
        "major": {
          ...
          "oration_lat": "Deus, qui beáto Wigbérto exímium in informánda iuventúte zelum tribuísti, concéde, quǽsumus, ut quæ te dante divínæ legis háusimus mandáta, ad própriam et próximi salútem fidéliter exsequámur.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Wigbert (†°um 737)",
          "patr_werk": "Brief an die Mönche von Glastonbury.",
          "patr_text": "^hNichts kann die trennen, die in der Liebe Christi verbunden sind^pDen heiligen und in Christus liebenswerten Herren Vätern und Brüdern im Kloster Glestingaburg (Glastonbury) erfleht der Priester Wigbert, euer und der Knechte Gottes Knecht, Heil im Herrn.^pGepriesen sei Gott, der will, dass alle Menschen gerettet werden und zur Erkenntnis der Wahrheit gelangen{1#1°Tim 2,4}.^pNach seinem Willen sind wir in diese Provinzen, das heißt in das Grenzgebiet der heidnischen Hessen und Sachsen, aufgebrochen; und er hat unsere Reise, die wir mit eurer Erlaubnis angetreten haben, ohne unser Verdienst, nur auf Grund eurer Gebete und seiner Barmherzigkeit, glücklich über das Meer und durch alle Fahrnisse dieser Welt gelenkt.^pWie ihr, liebe Brüder, wisst, können uns Entfernungen der Länder nicht trennen, da uns die Liebe Christi verbindet. So bleibt ihr, ehrwürdige Brüder, stets in meinem Geist, wie ich auch allzeit für euch zu Gott bete.^pIch will euch nun wissen lassen, meine Lieben, dass unser Erzbischof Bonifatius, als er von unserer Ankunft hörte, uns die Ehre erwies, uns eine weite Strecke persönlich entgegenzureisen, und uns mit großer Liebenswürdigkeit aufnahm.^pGlaubt mir, Geliebte, dass unsere Mühen im Herrn für uns selbst nicht vergeblich sind, und dass auch ihr davon Lohn habt. Denn Gott verleiht in seiner Allmacht und seinem Erbarmen auf Grund eurer Verdienste unserem Werk ein gutes Gelingen, wenn es auch noch so gefahrbringend und fast in jeder Hinsicht mühevoll ist, bei Hunger und Durst und Kälte sowie unter den gegenseitigen Überfällen der Heiden sein Leben zu fristen.^pDarum bitte ich: Betet inständig für uns, dass uns das rechte Wort gegeben werde, sooft wir unseren Mund auftun{2#vgl.°Eph 6,19}, sowie Beharrlichkeit und Erfolg in unserem Werk.^pLebt wohl im Herrn! Grüßt die Brüder in der Runde, zuerst Abt Ingeld und unseren Konvent. Berichtet meiner Mutter Tetta und ihrem Konvent unsere glückliche Reise. Mit eindringlichen Bitten fordere ich alle auf, gemeinsam mit uns inständig füreinander zu beten. Mein Wunsch ist, dass der gnädige Gott eure Seligkeit (die für uns betet) in seinem Schutz erhalte.",
    ...
    "16": {
      "Fulda": {
        "major": {
          ...
          "oration_lat": "Clementíssime Deus, qui beátum Rochum temporibus advérsis in adiuvándis infírmis et egénis virtúte constantíæ et patiéntiæ roborásti: præsta, quǽsumus, ut qui eius festum cólimus, ipsíus précibus a córporis et ánimæ noxa liberáti ægrótis et afflíctis subveniámus.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Gregor von Nazianz (†°390)",
    ...
    "25": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hEin gerechter König richtet das Land auf^pLieber Sohn, an erster Stelle möchte ich dich lehren, den Herrn, deinen Gott, aus deinem ganzen Herzen und aus allen Kräften zu lieben; denn ohne das gibt es kein Heil.^pMein Sohn, du sollst dich vor all dem hüten, wovon du weißt, dass es Gott missfällt, das heißt vor jeder schweren Sünde. Eher sollst du dich jeder Art von Martyrium unterwerfen als eine Todsünde begehen.^pWenn Gott zulässt, dass dich ein Unglück trifft, musst du es bereitwillig ertragen und bedenken, dass es dir zum Guten ausschlägt und dass du es vielleicht durchaus verdient hast. Schenkt Gott dir aber Wohlergehen, sollst du ihm demütig danken.^pHüte dich, dass du nicht schlechter wirst, sei es durch eitle Ruhmsucht oder auf irgendeine andere Weise; denn du darfst nicht mit den Gaben Gottes gegen Gott streiten oder ihn beleidigen.^pGern und fromm höre den Gottesdienst der Kirche. Wenn du im Gotteshaus bist, hüte dich umherzuschauen, und führe keine leeren Gespräche. Vielmehr bete zu Gott mit Worten des Mundes oder in der Betrachtung des Herzens.^pDein Herz sei gütig gegen die Armen, Elenden und Betrübten. Komm ihnen nach Möglichkeit entgegen und tröste sie! Danke Gott für alle Gaben, die er dir verliehen hat, damit du noch größerer würdig wirst.^pSei gerecht gegenüber deinen Untertanen. Halte den Weg der Gerechtigkeit ein, und weiche nicht zur Rechten oder zur Linken ab! Schlag dich stets eher auf die Seite der Armen als auf die der Reichen, bis du sicher bist, die Wahrheit gefunden zu haben. Sei sorgfältig darauf bedacht, dass alle deine Untertanen im Schutz der Gerechtigkeit und des Friedens leben können, besonders kirchliche Personen und Ordensleute.^pSei unserer Mutter, der römischen Kirche, und dem Papst als dem geistlichen Vater ergeben und gehorsam. Bemühe dich, dass aus deinem Land alle Sünden verschwinden, besonders Gotteslästerung und Irrlehre.^pLieber Sohn, ich gebe dir jeden Segen, den ein liebender Vater seinem Sohn geben kann. Die heilige Dreieinigkeit und alle Heiligen mögen dich vor allem Bösen bewahren. Der Herr gebe dir die Gnade, seinen Willen ganz zu erfüllen, so dass du ihm dienst und ihn ehrst und dass wir nach diesem Leben gemeinsam die Gnade erlangen, ihn ohne Ende zu schauen, zu lieben und zu loben. Amen.",
    ...
    "18": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hDie Lehrer der Kirche^pLieben und verehren will ich die von Christus gesandten Apostel und ihre Nachfolger, die so eifrig den Samen des Evangeliums ausstreuen und so unermüdlich mitarbeiten an der Ausbreitung des Wortes Gottes; sie können mit Recht bezeugen: Jeder erachte uns als Diener Christi und Ausspender der Geheimnisse Gottes{1#vgl. 1 Kor 4,1}. Als treubesorgter Hausvater wollte der Herr, dass durch solche Diener und Boten das Licht des Evangeliums an dem Feuer, das er vom Himmel gebracht hatte{2#vgl. Lk 12,49}, entzündet werde, dass es nicht unter den Scheffel gestellt, sondern auf den Leuchter erhoben werde{3#vgl. Mt 5,15; Lk 11,33} und so seinen Schein überallhin werfe und aller Finsternis und allem Irrtum bei Juden und Heiden ein Ende mache.^pDenn für einen Lehrer des Evangeliums genügt es nicht, wenn er durch sein Wort beim Volke Licht verbreitet, wenn er wie eine Stimme in der Wüste ist, wenn er durch sein Wort andere in der Frömmigkeit zu fördern sucht – auch das muss er tun, andernfalls, wenn er den Dienst des Wortes vernachlässigte, würde er vom Propheten ein stummer Hund genannt, der nicht bellen kann{4#vgl.°Jes 56,10} –, sondern er muss auch glühen vor Eifer, muss von Tatendrang und Liebe beseelt sein, damit er seinem Apostelamt Ehre macht und Paulus als seinem Vorbild folgt.^pDieser war nicht damit zufrieden, dem Bischof von Ephesus die Weisung zu geben: Das musst du fordern und lehren! Arbeite wie ein guter Streiter Jesu Christi!{5#vgl.°2°Tim 2,3} Er hat auch ständig bei Freund und Feind das Evangelium verkündigt; er konnte zu den Leuten in Ephesus mit gutem Gewissen sagen: Ihr wisst, dass ich euch nichts von dem, was euch nützlich sein kann, vorenthalten habe; alles habe ich euch verkündigt, öffentlich und in den Häusern; vor Juden und Heiden habe ich die Bekehrung zu Gott und den Glauben an unsern Herrn Jesus Christus feierlich bezeugt{6#vgl.°Apg 20,20-21}.^pEin Hirt der Kirche muss nämlich so sein, dass er wie Paulus allen alles wird{7#vgl. 1 Kor 9,22}, dass der Kranke bei ihm Genesung findet, der Betrübte Freude, der Verzweifelnde Vertrauen, der Unerfahrene Belehrung, der Schwankende Klarheit, der Reuevolle Vergebung und Trost, kurz, ein jeder das, was ihm zum Heile notwendig ist.^pDarum ist es sehr sinnvoll, dass Christus, als er die ersten Lehrer der Welt und der Kirche bestellte, zu seinen Jüngern nicht bloß sagte: Ihr seid das Licht der Welt, sondern auch hinzufügte: Eine Stadt, die auf dem Berge liegt, kann nicht verborgen bleiben, auch zündet man kein Licht an und stellt es unter den Scheffel, vielmehr stellt man es auf den Leuchter, dass es allen, die im Hause sind, leuchte{8#vgl.°Mt 5,14-15}. Denn die Prediger täuschen sich, wenn sie meinen, sie könnten ihrer Aufgabe mehr durch einen glänzenden Vortrag als durch ein tadelloses Leben und durch glühende Liebe Genüge leisten.",
    ...
    "21": {
      "eig": {
        ...
        "Lesehore": {
          ...
          "patr_werk": "Aus einer Homilie zum Festtag des Evangelisten Matthäus.",
    ...
    "26": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hKostbar ist der Tod der Märtyrer,^lerkauft um den Preis des Todes Christi^pDie ruhmvollen Taten der Märtyrer, von denen die Kirche überall erglänzt, sind uns ein augenscheinlicher Beweis für die Wahrheit des Verses, den wir soeben gesungen haben: „Kostbar ist in den Augen des Herrn der Tod seiner Heiligen“{1#vgl.°Ps 116,15}. Es ist kostbar in unseren Augen und in den Augen des Herrn, für dessen Name dieser Tod erlitten wurde. Aber der Preis für den Tod dieser vielen ist der Tod des einen. Wie viele sind es, deren Tod der eine sterbend erkaufte! Wäre er nicht gestorben, hätte sich das Weizenkorn nicht vermehrt. Ihr habt die Worte gehört, die er beim Herannahen seines Leidens – unserer Erlösung – sprach: „Wenn das Weizenkorn nicht in die Erde fällt und stirbt, bleibt es allein; wenn es aber stirbt, bringt es reiche Frucht“{2#Joh 12,24}.^pUnser Erlöser vollbrachte am Kreuz einen bedeutungsvollen Tausch: dort wurde das Gefäß, in dem sich der Kaufpreis befand, geöffnet. Als die Lanze Christi Seite aufstieß, floss sein Blut heraus: der Preis für die ganze Welt. Erkauft sind die Glaubenden und die Märtyrer; aber bei den Märtyrern ist der Glaube sichtbar unter Beweis gestellt: Das Blut ist Zeuge!^pSie gaben zurück, was ihnen verliehen war, und erfüllten so, was der heilige Johannes sagt: „Wie Christus sein Leben für uns hingegeben hat, so müssen auch wir für die Brüder das Leben hingeben“{3#vgl.°1°Joh°3,16}, und ein andermal heißt es: „Wenn du an großer Tafel sitzt, achte wohl darauf, was dir vorgesetzt wird“{4#Spr 23,1 Vg}; denn du musst als Gegengabe ein ähnliches Mahl bereiten. Eine große Tafel ist es, an welcher der Herr der Tafel selbst die Speise ist. Niemand sonst gibt sich selbst als Nahrung den Tischgenossen. Christus tut es: er lädt ein, und er ist selber die Speise. Die Märtyrer wussten, was sie aßen und tranken, und eben dies gaben sie auch zurück.^pAber wie hätten sie zurückzugeben vermocht, hätte nicht der Herr zuerst den Kaufpreis aufgebracht und ihnen mitgeteilt, wovon sie geben können? „Wie kann ich dem Herrn all das vergelten, was er mir Gutes getan hat? Ich will den Kelch des Heils ergreifen“{5#Ps 116,12.13} Was für ein Kelch ist das! Es ist der bittere, aber Heil schaffende Kelch des Leidens. Hätte nicht der Arzt als erster diesen Kelch getrunken, musste sich der Kranke fürchten, ihn anzurühren. Dieser Kelch des Leidens ist gemeint; denn aus dem Mund Christi erfahren wir, was für ein Kelch das ist: „Vater, wenn es möglich ist, gehe dieser Kelch an mir vorbei!“{6#Mt 26,39}. Von diesem Kelch sagen die Märtyrer: „Ich will den Kelch des Heils ergreifen und anrufen den Namen des Herrn“{7#Ps 116,13}.^pDu fürchtest also nicht, dabei zu versagen? Weshalb fürchtest du es nicht? Weil es heißt: „Ich will anrufen den Namen des Herrn!“{8#Ps 116,13}. Wie hätten die Märtyrer siegen können, hatte nicht der in ihnen gesiegt, von dem das Wert stammt: „Freut euch, ich habe die Welt besiegt“{9#vgl.°Joh°16,33}. Der Herrscher des Himmels lenkte Herz und Zunge der Märtyrer. Er überwand durch die Märtyrer den Teufel auf der Erde und krönte sie im Himmel. Selig, die so diesen Kelch tranken! Ihre Leiden sind beendet, und sie haben den Ehrenkranz empfangen.",
          "patr_resp1": "Die Heiligen vergossen ihr Blut für den Herrn, sie liebten Christus in ihrem Leben und folgten ihm nach bis in den Tod.  ",
          "patr_resp2": "Darum schenkte ihnen der Herr den Siegeskranz.",
          "patr_resp3": "Ein Geist und ein Glaube war in ihnen."
        },
    ...
    "28": {
      "n1": {
        "major": {
          ...
          "oration_lat": "Deus, qui beátam Líobam in evangélio propagándo beáto Bonifátio sóciam dedísti, mitte, quǽsumus, operários in messem tuam, quorum prece et zelo apostólico in pópulo nostro fides semper vera profíciat.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Rudolf von Fulda († 865)",
          "patr_werk": "Aus der Lebensbeschreibung der heiligen Lioba.",
          "patr_text": "^hEine Frau von großen Tugenden^pBonifatius gab den Klöstern die Regel, nach der sie ihr Leben ausrichten sollten, und bestellte für sie treue Hüter. Den Mönchen gab er Sturmius zum Abt, für die Jungfrauen bestimmte er die Jungfrau Lioba zur geistlichen Mutter und wies ihr das Kloster in Tauberbischofsheim zu, wo eine nicht geringe Anzahl von Dienerinnen Gottes lebte. Diese wurden nach dem Vorbild ihrer heiligen Meisterin Lioba durch das Studium der christlichen Lehre gebildet. Sie machten durch diese Unterweisung solche Fortschritte, dass mehrere von ihnen später selbst Meisterinnen wurden. So kam es, dass es in jenen Gebieten keine oder kaum Frauenklöster gab, die sich nicht um Lehrerinnen aus der Zahl ihrer Schülerinnen bemüht hätten. ^pLioba war eine Frau von großen Tugenden und stand so fest zu ihrer einmal übernommenen Lebens­aufgabe, dass sie nicht an ihre Heimat und Ver­wandt­schaft dachte, sondern allen Eifer auf das begonnene Werk verwandte. Sie erwies sich untade­lig vor Gott und war all ihren Untergebenen ein Vor­bild der Heiligkeit in Wort und Tat. Ihr Aussehen war wie das eines Engels, ihr Wort erfreute das Herz, ihr Verstand war klar, ihre Klugheit groß, ihr Glaube katholisch, ihre Hoffnung ausdauernd, ihre Liebe sich selbst verströmend. Niemals hat jemand einen Fluch aus ihrem Mund gehört, niemals ging die Sonne über ihrem Zorn unter {1#vgl.°Eph°4,26}. Speise und Trank bot sie zwar anderen mit größter Zuvor­kommenheit an, nahm sie aber für sich nur mit äußerster Mäßigung. ^pDer Schriftlesung oblag sie mit solchem Eifer, dass sie das heilige Buch nicht aus der Hand legte außer beim Beten, Essen und Schlafen. Mit scharfem Ver­stand studierte sie die Bücher des Alten und Neuen Testamentes und prägte die göttlichen Gebote ihrem Gedächtnis ein. Darüber hinaus fügte sie der reichen Fülle ihres Wissens noch die Sprüche der Kirchen­väter, die Beschlüsse der Konzilien und die Bestim­mungen der ganzen kirchlichen Rechtsordnung hinzu.^pAlles, was sie tat und bestimmte, war reiflich über­legt; bei allem, was sie tat, bedachte sie zuvor den Ausgang, um nicht später etwas bereuen zu müssen, was, unüberlegt begonnen, nicht vollendet werden konnte.^pDa sie sich bewusst war, dass zu eifrigem Beten und fleißigem Lesen geistige Spannkraft nötig ist, pflegte sie im Wachen wie auch im übrigen Tugendstreben immer Maß zu halten. ^pBesonders sorgfältig pflegte Lioba die Gastfreund­schaft: Allen, ohne Unterschied der Person, öffnete sie ihr Haus und bereitete ihnen wie eine sorgende Mutter das Mahl, während sie selber fastete. Auch wusch sie allen mit eigenen Händen die Füße, um die Anordnung des Herrn dienend zu befolgen.",
          ...
          "patr_resp3": "Nehmt euch der Schwachen an, seid geduldig mit allen; bemüht euch immer, einander und allen Gutes zu tun."
        },
        "Laudes": {
          "button": "Hl. Lioba",
      ...
      "n2": {
        ...
        "Lesehore": {
          "patr_autor": "LEER",
          "patr_werk": "Aus dem ersten altslawischen Heiligenlektionar.",
          "patr_text": "^hDer Thron des Königs, dere die Armen in Wahrhaftigkeit richtet, wird für ewig gefestigt.^pAls Wratislaw, der Vater Wenzels, gestorben war, …",
          "patr_resp1": "Der Gerechte gedeiht wie die Palme",
          "patr_resp2": "und blüht vor dem Herrn auf ewig.",
          "patr_resp3": "Er ist gepflanzt im Hause des Herrn, in den Vorhöfen unseres Gottes,"
        },
        "Laudes": {
          "button": "Hl. Wenzel",
          "farbe": "r"
      ...
      "n3": {
        ...
        "Laudes": {
          ...
          "farbe": "r",
          "genitiv": "des heiligen Lorenzo Ruiz und seiner Gefährten",
          "genitiv_lat": "sancti Lauréntii et eius sociórum"
        }
      }
    },
    "30": {
    ...
    "9": {
      "Fulda": {
        "major": {
          ...
          "oration_lat": "Deus, qui beátum Gunthérum mónachum miræ caritátis próximi et dissidéntes conciliándi grátia decorásti, concéde, quǽsumus, eius intercessióne, ut caritátis ópera exercéntes, ad pacem concordiámque fovéndam semper simus inténti.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "LEER",
          "patr_werk": "Aus dem „Leben des Einsiedlers Gunther“.",
          "patr_text": "^hWir sind nur Gast auf Erden^pDer Diener Gottes Gunther war mehr darauf aus, in der Welt Unbill zu leiden, als Lob zu ernten, er wollte sich lieber bis zur Erschöpfung im Dienst Gottes abmühen, als sich von den Wogen des Glücks in diesem Leben tragen zu lassen. Darum bat er seinen Abt, den Herrn Godehard, um die Erlaubnis, ins Böhmische Gebirge zu ziehen, und ließ sich mit einigen Gefährten, die ihm von Altaich folgten, an einem einsamen Ort nieder. Dort erbaute er eine kleine Zelle zu Ehren des heiligen Johannes des Täufers und nannte den Ort Rinchnach.^p37 Jahre lebte er dort mit seinen Gefährten im Streben nach Vollkommenheit und in peinlicher Beobachtung der frei gewählten Armut. Dort war ihr Lebensunterhalt nicht gesichert; da gab es keine köstlichen Speisen, zu trinken gab es nur Wasser, und selbst dieses wurde nur den Gästen ausreichend angeboten, den Brüdern aber zugemessen.^pGunther konnte nicht lesen und schreiben, hatte nur einige Psalmen gelernt; dennoch hatte er durch der Brüder häufiges Vorlesen und durch begieriges Hinhören auf die Verkündigung des Wortes Gottes sich ein so vollständiges Verständnis der Evangelien und des Alten Testamentes angeeignet, dass er oft vor seinen staunenden Zuhörern schwierige, mystisch zu verstehende Stellen vortrug.^pWir haben vorher kurz berichtet, wie Gunther, ein Mann aus adeligem Geschlecht, sich bekehrte und durch Buße und Wiedergutmachung das Wohlgefallen Gottes erwarb; das sollte uns Ansporn genug sein, sein gutes Beispiel nachzuahmen. Denn siehe, das Kamel ist durch das enge Nadelöhr gegangen, von dem geführt, für den nichts unmöglich oder schwierig ist, der wunderbar ist in seinen Werken, besonders in seinen Erbarmungen; der niemand verlässt, und hätte er sich noch so schwer verfehlt, und der Sünden nicht mehr gedenkt, wo Buße geschieht; der in einer Stunde den Frevler umwandelt und zum Heiligen macht.^pIn seiner Kraft hat der Bekenner Christi Gunther gekämpft und dem bösen Feind das Haupt zertreten. Freilich hat über die Tugenden dieses ehrwürdigen Mannes, durch die er den Feind überwand, oder über die Nachstellungen, die er von jenem zu erdulden hatte, niemand genaue Kunde, weil man lange Zeit nichts von ihm wusste. Aber wenn er auch seinen Aufenthaltsort gewechselt hat, so doch nicht seinen Feind; und so kann man nicht zweifeln, dass er, je mehr er an Heiligkeit zunahm, um so heftigere Kämpfe zu bestehen hatte.^pLasst uns also Herz und Sinn erheben, um dem Beispiel der Heiligen nachzueifern; um, da wir ihre Taten preisen, auch selbst ein vorbildliches Leben zu führen gemäß der Mahnung des Psalmisten: Sucht den Herrn, so wird euer Herz aufleben{1#Ps 69,33 Vg}. Da wir aber, durch unsere Schwachheit niedergehalten, nicht die Kraft haben, nach der Höhe zu streben, so lasst uns mit ganzer Seele die Fürbitte dieses heiligen Vaters erflehen. Und er, der einst gekommen ist, nicht Gerechte, sondern Sünder zu berufen, wolle auf die Bitten seines geliebten Bekenners unsere Herzen mit dem Feuer des Heiligen Geistes entflammen und uns aus diesem Jammertal und vom Weg unserer Pilgerschaft zu sich rufen in die ewige Heimat.",
      ...
      "n2": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hSei ein treuer und tapferer Zeuge!^pEs gibt vielerlei Verfolgungen und so auch vielerlei Martyrien. Täglich kannst du Zeuge Christi sein.^pWenn du vom Geist der Unzucht versucht wirst, aber das kommende Gericht Christi fürchtest und darum die Keuschheit des Leibes und der Seele nicht verletzen zu dürfen glaubst, dann bist du ein Zeuge Christi. Wenn der Geist des Geizes dich versucht, den Besitz der Ärmeren anzutasten und die Rechte der Wehrlosen Witwe zu verletzen, du jedoch die Gebote Gottes bedenkst und dich entscheidest, lieber zu helfen als Unrecht zu tun, dann bist du ein Zeuge Christi! Solche Zeugen liebt Christus, wie die Schrift sagt; „Verschafft den Waisen Recht, tretet ein für die Witwen!, spricht der Herr“{1#Jes 1,17}.^pWenn dich der Geist des Stolzes versucht, du aber beim Anblick der Armen und Bedürftigen Mitleid im Herzen fühlst und die Demut mehr liebst als die Anmaßung, dann bist du ein Zeuge Christi. Nicht nur mit Worten gibst du Zeugnis, sondern durch Taten.^pWelcher Zeuge wäre glaubwürdiger als der, welcher bekennt: „Jesus Christus ist im Fleisch gekommen“{2#1°Joh°4,2}, und der die Gebote des Evangeliums hält? Denn wer hört, aber nicht tut, leugnet Jesus Christus. Wenn er auch mit dem Mund bekennt, so leugnet er doch durch die Tat. „Viele werden an jenem Tag sagen: Herr, Herr, sind wir nicht in deinem Namen als Propheten aufgetreten, und haben wir nicht mit deinem Namen Dämonen ausgetrieben und mit deinem Namen viele Wunder vollbracht?“ Aber der Herr wird erwidern: „Weg von mir, ihr Übertreter des Gesetzes!“{3#Mt 7,22.23} Ein Zeuge ist also der, bei dem Worte und Taten übereinstimmen und der so die Gebote des Herrn bezeugt.^pWie viele Märtyrer Christi, die den Herrn Jesus bekennen, gibt es also täglich im verborgenen! Der Apostel weiß um dieses Martyrium, da er schreibt: „Das ist unser Ruhm, und dafür zeugt auch unser Gewissen“{4#2°Kor°1,12}. Wie viele haben äußerlich bekannt und innerlich geleugnet. Es heißt: „Traut nicht jedem Geist!“{5#1°Joh°4,1}, sondern an ihren Früchten erkennt, wem von ihnen ihr trauen könnt. Sei also treu und tapfer in den inneren Verfolgungen, damit du dich auch in den äußeren bewährst.",
    ...
    "18": {
      "eig": {
        "each": {
          ...
          "oration_lat": "Dómine Deus, qui beátum Lucam elegísti, ut prædicatióne et scriptis mystérium tuæ in páuperes dilectiónis reveláret, concéde, ut, qui tuo iam nómine gloriántur, cor unum et ánima una esse persevérent, et omnes gentes tuam mereántur vidére salútem.^ORlV"
        },
        "Laudes": {
          "button": "Hl. Lukas",
          "farbe": "r",
        ...
        "Vesper": {
          "antev": "In seinem heiligen Bericht hat Lukas uns Christi Güte und Erbarmen bezeugt. Darum preist ihn heute die ganze Kirche.",
          "antev_lat": "Beátus Evangelísta Lucas, scriba mansuetúdinis Christi, digne in Ecclésia clarificári méruit.",
          "hymn_1_lat": 9018.0
        }
      }
    },
    ...
    "26": {
      "Fulda": {
        "major": {
          ...
          "oration_lat": "Deus, qui beátum Albuínum divína caritáte flagrántem, fidéque, quæ vincit mundum, insígnem, sanctis pastóribus mirabíliter aggregásti, præsta, quǽsumus, ut, ipso intercedénte, nos quoque, in fide et caritáte perseverántes, eius glóriæ consórtes fíeri mereámur.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Augustinus (†°430)",
    ...
    "4": {
      "eig": {
        "major": {
          ...
          "oration_lat": "Custódi, quǽsumus, Dómine, in pópulo tuo spíritum, quo beátum Cárolum epíscopum implevísti, ut Ecclésia indesinénter renovétur, et, Christi se imágini confórmans, ipsíus vultum mundo váleat osténdere.^ORlV"
        },
        "Lesehore": {
    ...
    "15": {
      "n1": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hHirte und Lehrer zum Aufbau des Leibes Christi^p„Tut dies zu meinem Gedächtnis!“{1#Lk 22,19} An diesem Satz ist zweierlei zu beachten: Das eine ist der Auftrag, dieses Sakrament zu vollziehen, was mit den Worten gemeint ist: „Tut dies!“ Das andere ist, dass das Sakrament ein Gedächtnis des Herrn ist, der für uns in den Tod geht.^pEr sagt: „Tut dies!“ Kein Auftrag ist nützlicher, liebevoller und heilsamer, keiner liebenswerter; kein Auftrag kommt dem ewigen Leben so nahe. Das soll nun im einzelnen gezeigt werden.^pDer Auftrag ist nützlich zur Vergebung der Sünden, und er ist im Leben das nützlichste, um die Fülle der Gnade zu gewinnen. Der Vater der Geister unterrichtet uns in dem, was nützlich ist, um seine Heiligung zu erlangen{2#vgl.°Hebr 12,10}. Die Heiligung liegt in seiner Opferhingabe, das heißt darin, dass er sich im Sakrament für uns darbrachte und dass er sich uns hingab zum Genuss: ‚Für euch heilige ich mich‘{3#vgl.°Joh°17,19}. Christus hat sich selbst durch den Heiligen Geist als makelloses Opfer Gott dargebracht. Er wird unser Gewissen von den toten Werken reinigen, damit wir dem lebendigen Gott dienen{4#vgl.°Hebr 9,14}.^pNichts Liebevolleres können wir tun. Denn was könnte liebevoller sein als das, worin Gott uns gegenüber seine ganze Güte zeigt?^pKein Auftrag konnte besser sein für unser Heil. Denn dieses Sakrament ist die Frucht des Lebensbaums. Wer mit Hingabe und aufrichtigem Glauben davon isst, wird auf ewig den Tod nicht erleiden{5#vgl.°Joh°8,52}: ‚Ein Lebensbaum ist die Weisheit für jeden, der nach ihr greift, und wer sie festhält, ist glücklich zu preisen‘{6#vgl.°Spr 3,18}. Und: ‚Jeder, der mich isst, wird durch mich leben‘{7#vgl.°Joh°6,57}.^pKein Auftrag könnte liebenswerter sein. Denn dieses Sakrament wirkt Liebe und Einheit. Es ist höchstes Zeichen der Liebe, dass er sich selbst zur Speise reicht: „Meine Zeltgenossen müssen gestehen: Wer gäbe uns von seinem Fleisch, um satt zu werden?“{8#vgl.°Ijob 31,31 Vg} Es ist, als sagte er: So sehr habe ich sie geliebt und sie mich; ich verlangte danach, in ihrem Herzen zu sein, dass sie mich so genießen, um meinem Leib angegliedert zu werden. Nicht inniger und natürlicher konnten sie mit mir vereinigt werden und ich mit ihnen. Kein Auftrag konnte dem ewigen Leben näher kommen. Denn die ununterbrochene Dauer des ewigen Lebens kommt daher, dass Gott mit seiner Güte sich selber den in der Seligkeit Lebenden einflößt.",
    ...
    "19": {
      "eig": {
        "major": {
          ...
          "oration_lat": "Deus, qui beátæ Elísabeth tribuísti in paupéribus Christum cognóscere ac venerári, da nobis, eius intercessióne, egénis et tribulátis iugi caritáte servíre.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Konrad von Marburg († 1233)",
          "patr_werk": "Aus einem Brief an Papst Gregor IX.",
          "patr_text": "^hElisabeth sah und liebte in den Armen Christus^pSchon früh begann Elisabeth in der Tugend zu er­starken. Wie sie in ihrem ganzen Leben eine Tröste­rin der Armen war, so wurde sie ganz und gar eine Wohltäterin der Hungernden, als sie bei einer ihrer Burgen ein Spital errichten ließ, in dem sie viele Kranke und Schwache aufnahm. An alle, die sie um ein Almosen baten, teilte sie dort in reichem Maß Liebesgaben aus und das nicht nur dort, sondern auf dem ganzen Gebiet des Landgrafen. Die gesamten Einkünfte, die sie aus vier Herrschaften ihres Gemahls bezog, gab sie so restlos aus, dass sie zuletzt ihren ganzen persönlichen Aufwand und ihre kostbaren Kleider für die Armen verkaufen ließ.^pZweimal am Tag, morgens und abends, pflegte sie alle ihre Kranken selbst zu besuchen und versorgte dabei die besonders Abstoßenden unter ihnen persönlich. Dem einen reichte sie das Essen, den anderen bettete sie, wieder andere trug sie auf der Schulter und erwies ihnen viele menschliche Dienste. All dem schaute ihr Gatte seligen Andenkens nicht ungnädig zu. Als er gestorben war, wollte Elisabeth nach der höchsten Vollkommenheit streben und bat mich unter vielen Tränen, ihr zu erlauben, von Tür zu Tür zu betteln.^pAm Karfreitag, als die Altäre entblößt waren, legte sie in einer Kapelle ihrer Stadt, wo sie die Franziska­ner angesiedelt hatte, in Gegenwart einiger Zeugen die Hände auf den Altar und verzichtete auf ihren eigenen Willen, auf allen weltlichen Aufwand und auf alles, was man nach dem Rat, den der Erlöser im Evangelium gibt, verlassen soll. Als sie dann erkann­te, dass die Unrast der Welt und der irdische Glanz, in dem sie zu Lebzeiten ihres Mannes hochgeehrt gelebt hatte, sie immer noch voll beanspruchen könnte, folgte sie mir gegen meinen Willen nach Marburg. Dort erbaute sie in der Stadt ein Spital, sammelte die Kranken und Schwachen und setzte die Elendesten und Verachtetsten zu sich an den Tisch.^pAbgesehen von diesem ihrem tätigen Leben, muss ich vor Gott bekennen, dass ich noch selten eine Frau gekannt habe, die in höherem Grade auch die Gabe der Beschauung gehabt hätte. Einige Ordensfrauen und Ordensmänner haben sie gesehen, wenn sie aus der Zurückgezogenheit des Betens kam. Dann leuch­tete häufig ihr Gesicht, und aus ihren Augen drangen Strahlen wie von der Sonne.^pVor dem Tod habe ich ihre Beichte gehört. Als ich sie fragte, was wegen ihres Besitzes und des Hausrates verfügt werden solle, erwiderte sie, was sie schon lange nur scheinbar besitze, gehöre den Armen. Sie bat mich, alles zu verteilen bis auf das abgetragene Hemd, das sie anhatte und mit dem sie begraben werden wolle. Darauf empfing sie den Leib des Herrn und sprach bis gegen Abend immer wieder von dem Besten, was sie in Predigten gehört hatte. Dann empfahl sie in tiefer Frömmigkeit die Umstehenden Gott und hauchte den Geist aus, als ob sie nur in einen sanften Schlaf sinke.",
          "patr_resp1": "Elisabeth hat den Heiligen die Füße gewaschen, hat den Bedrängten geholfen.",
          "patr_resp2": "Auf jedes gute Werk war sie bedacht.",
    ...
    "24": {
      "eig": {
        "major": {
          ...
          "oration_lat": "Deus, omnis paternitátis fons et orígo, qui beátos mártyres Andréam et sócios eius Cruci Fílii tui usque ad sánguinis effusiónem fidéles effecísti, eórum intercessióne concéde, ut amórem tuum inter fratres propagántes fílii tui nominári et esse valeámus.^ORlV"
        },
        "Laudes": {
  ...
  "12": {
    ...
    "3": {
      "eig": {
        "major": {
          ...
          "oration_lat": "Deus, qui beáti Francísci prædicatióne multos tibi pópulos acquisísti, da ut fidélium ánimi eódem fídei zelo férveant, et ubérrima ubíque prole Ecclésia sancta lætétur.^ORlV"
        },
        "Lesehore": {
    ...
    "7": {
      "eig": {
        "major": {
          ...
          "oration_lat": "Deus, qui beátum Ambrósium epíscopum cathólicæ fídei doctórem et apostólicæ fortitúdinis exémplum effecísti, éxcita in Ecclésia tua viros secúndum cor tuum, qui eam fórtiter et sapiénter gubérnent.^ORlV"
        },
        "Lesehore": {
          "patr_autor": "Ambrosius († 397)",
    ...
    "9": {
      "Fulda": {
        ...
        "Vesper": {
          ...
          "antev_lat": "Torménta, quæ in plúribus olim tyránnis excogitávit, in Libório furor exércuit omnia. Hæc ánimo tulit, qui mártyres decet, constánti."
        }
      },
      "n2": {
        "major": {
          ...
          "oration_lat": "Deus, qui per beátum Ioánnem Dídacum, sanctíssimæ Vírginis Maríæ dilectiónem erga pópulum tuum ostendísti: eius nobis intercessióne concéde, ut, Matris nostræ mónitis Guadalúpæ datis obsequéntes, voluntátem tuam iúgiter adimplére valeámus.^ORlV"
        },
        "Laudes": {
    ...
    "10": {
      "n1": {
        "major": {
          "comm_1": "Maria",
          "oration": "Herr, unser Gott, du hast die Verheißungen an die Väter erfüllt und die selige Jungfrau Maria auserwählt. Gib uns die Kraft, ihrem Beispiel zu folgen, denn ihre Demut hat dir gefallen und ihr Gehorsam war für uns der Anfang des Heils.^ORV",
          "oration_lat": "Deus, qui promíssa Pátribus adímplens beátam Vírginem Maríam elegísti, ut matrem fíeret Salvatóris, concéde nobis illíus exémpla sectári, cuius humílitas tibi plácuit, et obœdiéntia nobis prófuit.^ORlV"
        },
        "Laudes": {
    ...
    "12": {
      "n1": {
        "major": {
          "comm_1": "Maria",
          "oration": "Gott, du Vater des Erbarmens, du hast dein Volk unter den besonderen Schutz der heiligen Mutter deines Sohnes gestellt. Gewähre allen, die die selige Jungfrau von Guadalupe anrufen, dass sie in immer festerem Glauben den Fortschritt der Völker auf Wegen der Gerechtigkeit und des Friedens suchen.^ORV",
          "oration_lat": "Deus, Pater misericordiárum, qui sub sanctíssimæ Matris Fílii tui singulári patrocínio plebem tuam constituísti, tríbue cunctis, qui beátam Vírginem Guadalupénsem ínvocant, ut, alacrióri fide, populórum progressiónem in viis iustítiæ quǽreant et pacis.^ORlV"
        },
        "Laudes": {
          "button": "Unsere Liebe Frau von Guadalupe",
          "farbe": "m"
        }
      }
    },
    "13": {
      "eig": {
        ...
        "Lesehore": {
          ...
          "patr_text": "^hDie Anmut des Leibes erleuchtest du mit dem Glanz des Geistes^pDem einfachen Volk gehörst du an; aber vor allem: du bist eine aus den Jungfrauen, welche die Anmut des Leibes mit dem Glanz des Geistes erleuchtet; fast bist du mit der Kirche zu vergleichen. Nächtlicherweile sinne in deiner Kammer über Christus nach und erhoffe jeden Augenblick seine Ankunft!^pSo wollte dich Christus, als er nach dir verlangte, so wollte er dich, als er dich erwählte. Er hat versprochen, zu dir zu kommen, er enttäuscht dich nicht. Durch die offene Tür kommt er herein. Umarme ihn also, den du gesucht hast{1#vgl.°Hld 2,1}. „Tritt hin zu ihm, und du wirst erstrahlen“{2#Ps 34,6 Vg}. Halte ihn fest, bitte ihn, dass er nicht schnell wieder geht, beschwöre ihn, dass er bleibt. Denn das Wort Gottes eilt{3#vgl.°Ps 147,15}. Wer hochmütig ist, fasst es nicht; wer gleichgültig, hält es nicht fest. Deine Seele gehe seinem Wort entgegen, hefte dich an die Spur seiner himmlischen Rede; denn er eilt schnell vorüber!^pDenn was sagt jene (Braut)? „Ich suchte ihn, ich fand ihn nicht. Ich rief ihn, er antwortete nicht“{4#Hld 5,6}. Denk nicht, dass du ihm missfällst, weil du gerufen, gebeten und aufgemacht hast, er aber so schnell wieder wegging. Oft lässt er Prüfung über uns kommen. Was sagte er schließlich, als das Volk ihn bat, nicht wegzugehen? „Ich muss auch den anderen Städten das Wort Gottes verkünden; denn dazu bin ich gesandt worden“{5#vgl.°Lk 4,43}.Wenn es dir auch scheint, er sei weggegangen, geh hinaus und suche wieder nach ihm.^pWer darf dich lehren, Christus festzuhalten, als die Kirche allein? Ja, sie hat es dich schon gelehrt, wenn du verstehst, was du bist: „Kaum war ich an ihnen vorüber, fand ich ihn, den meine Seele liebt. Ich fasste ihn und ließ ihn nicht mehr los“{6#Hld 3,4}.^pWomit wird Christus also festgehalten? Nicht mit Schlingen des Unrechts. nicht mit Seilen und Stricken, sondern mit Fesseln der Liebe, mit Zügeln des Geistes lässt er sich binden und festhalten durch die Zuneigung des Herzens.^pWenn auch du Christus festhalten willst, such ihn und fürchte keine Pein. Denn häufig lässt er sich besser finden, wenn der Leib gezüchtigt wird, den Verfolgern in die Hände gefallen ist.^p„Kaum war ich an ihnen vorüber“, sagt sie. Denn eine kleine Weile, einen kurzen Augenblick, nachdem du den Verfolgern entronnen bist, ohne den Mächten der Welt unterlegen zu sein, da kommt dir Christus entgegen und lässt nicht länger zu, dass du auf die Probe gestellt wirst. Die Christus so sucht und findet, kann sagen: „Ich fasste ihn, ich ließ ihn nicht mehr los, bis ich ihn in das Haus meiner Mutter brachte, in die Kammer derer, die mich geboren hat“{7#Hld 3,4} .Was ist das Haus deiner ;Mutter und ihre Kammer, wenn nicht der innerste und verborgenste Winkel deines Wesens!^pAuf dieses Haus habe acht und reinige sein Innerstes. Wenn es makellos ist, dann wird es sich als geistliches Haus erheben für ein heiliges Priestertum, vom Schlussstein zusammengehalten, und der Heilige Geist wird in ihm wohnen{8#vgl.°1°Petr°2,5; Eph 8,20}.^pDie Christus so sucht, die ihn so beschwört, die verlässt er nicht, ja er besucht sie oft. Denn er ist bei uns bis ans Ende der Welt{9#vgl.°Mt 28,20}.",
