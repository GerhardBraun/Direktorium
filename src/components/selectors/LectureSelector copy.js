    ...
    const availableAlternatives = useMemo(() => {
        ...
        secondAlternatives.forEach((altData, index) => {
            ...
            secondReadings.push({
                ...
                bezug: formatPrayerText(checkLanguageField('patr_bezug', altData)),
        ...
        return {
            first: {
                ...
                onlyAlternativeResp: firstReadings.every(b => b.index > 0 && b.onlyResp),
            ...
            second: {
                ...
                onlyAlternativeResp: secondReadings.every(b => b.index > 0 && b.onlyResp),
            ...
            <div className="mb-4">
                {alternatives.map((button) => (
                    <button
                        ...
                        className={`w-full text-sm text-left px-2 pt-2 pb-1 mt-1 rounded ${button.index > 0 ? 'mr-2' : ''}
    ...
    "MariaSaLh": {
        second: [
            ...
            },
            {
                ...
                patr_bezug: "(aus den Commune-Texten)",
