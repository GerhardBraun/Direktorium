...
const MarAntSelector = ({ season, localPrefLatin, formatPrayerText }) => {
    ...
    const marianAntiphons = useMemo(() => [
        // Alma Redemptoris Mater (Advent bis Lichtmess)
        {
            ...
            title_lat: "Alma Redemptóris Mater",
        ...
        <div className="w-full">
            ...
            {sortedAntiphons.map((ant) => (
                <button
                    ...
                    className={`w-full text-sm text-left pl-2 pt-1 pb-0 mt-1 rounded
                    ${ant.season === (season === 'w' ? 'a' : season) ? 'bg-gray-300 dark:bg-gray-600' : 'bg-gray-100 dark:bg-gray-800'}
