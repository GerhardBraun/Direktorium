...
const LanguageProgress = () => {
    ...
    const progressText = "^kAktueller Bearbeitungsstand^0k^p^fNeue Einheitsübersetzung^0f^lAlle Psalmen und Cantica und alle Kurzlesungen können in der neuen Einheitsübersetzung angezeigt werden.^lDie Lesungen der Lesehore werden nachrangig behandelt und vorerst nicht eingearbeitet.^p^flateinischer Text der Liturgia Horarum^0f^lFür das Stundengebet im Jahreskreis steht der Vierwochenpsalter vollständig zur Verfügung,^lebenso die Texte für die individuell wählbaren Feiern zur Kirchweihe und zum Gedächntnis der Verstorbenen.^pDie Eigentexte für die Sonntage und die bevorstehenden Hochfeste und Feste werden rechtzeitig zum Gebrauch ergänzt.^pVon den Commune-Texte fehlen noch die für die Erste Vesper bei einer lokalen Feier als Hochfest und die besonderen Texte in der Fastenzeit und Osterzeit.^pDie Lesungen der Lesehore werden nachrangig behandelt und vorerst nicht eingearbeitet.";
