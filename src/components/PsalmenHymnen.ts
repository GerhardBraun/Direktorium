...
export const psalmsData = {
  ...
  522: {
    0.0: {
      "text": "Alma Redemptóris Mater,^lquae pérvia caeli porta manes^let stella maris, succúrre cadénti,^lsúrgere qui curat, pópulo;^ltu quae genuísti, natúra miránte,^ltuum sanctum Genitórem,^lVirgo prius ac postérius,^lGabriélis ab ore sumens illud Ave,^lpeccatórum miserére."
    }
  },
  523: {
    0.0: {
  ...
  1402: {
    0.0: {
      ...
      "text": "Erwartet den Herrn,^lSteht als Knechte bereit an der Tür.^lSchon jauchzt jeder Stern,^lSeht, er kommt, seht, er kommt, wir sind hier.^l ^pKomm, Herr Jesus, Maranatha.^pEntzündet die Lampen, ihr Mägde,^lErglühet im Geist^lIm Kommen des Ewig-Geliebten,^lder Kyrios heißt.^l ^pKomm, Herr Jesus, Maranatha.^pDu wirfst dein Feuer zur Erde^lund willst, dass es brennt,^lund wir sind der Mund,^lder anbetend dein Kommen bekennt.^l ^pKomm, Herr Jesus, Maranatha."
    }
  },
  2201: {
    0.0: {
  ...
  2304: {
    0.0: {
      "text": "Jordan, sing!^lSchwing deine Wasser^lüber die Wüste hin.^lTrunken bist du vom Glanz darin:^pJesus, der Christus,^lsteht als Lamm in den Fluten.^pMenschheit, auf!^lLauf ihm entgegen,^ldeine Geburt ist nah!^lSieh, der Geliebte, die Hochzeit ist da:^pTrink seinen Wein,^lden neuen, glühenden, guten!^pHerrliches All!^lFall vor ihm nieder,^lbring dich als Gabe dar!^lChristus verwandelt dich wunderbar.^pEwiges Leben^lwird dich im Tode durchbluten!"
    }
  },
  2401: {
    0.0: {
