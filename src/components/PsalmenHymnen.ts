...
export const psalmsData = {
  ...
  129: {
    0.0: {
        ...
        "text": "Sie haben mich oft bedrängt von Jugend auf^*– so soll Israel sagen –,^psie haben mich oft bedrängt von Jugend auf,^*doch sie konnten mich nicht bezwingen.^pDie Pflüger haben auf meinem Rücken gepflügt,^*ihre langen Furchen gezogen.^pDoch der Herr ist gerecht,^*er hat die Stricke der Frevler zerhauen.^pBeschämt sollen alle weichen,^*alle, die Zion hassen.^pSie sollen wie das Gras auf den Dächern sein,^*das verdorrt, noch bevor man es ausreißt.^pKein Schnitter kann seine Hand damit füllen,^*kein Garbenbinder den Arm.^pKeiner, der vorübergeht, wird sagen:^+Der Segen des Herrn sei mit euch! – *^lWir aber segnen euch im Namen des Herrn."
      }
  },
  130: {
    0.0: {
  ...
  142: {
    0.0: {
        ...
        "text": "Das alles hat sich am Herrn erfüllt bei seinem Leiden. (Hilarius)"
      }
  },
  143: {
    0.0: {
  ...
  144: {
    1.0: {
        ...
        "text": "Gelobt sei der Herr, der mein Fels ist"
      },
    2.0: {
        "verses": "9–15",
        "text": "Ein neues Lied will ich, o Gott, dir singen"
      },
    3.0: {
        "verses": "1–10b",
